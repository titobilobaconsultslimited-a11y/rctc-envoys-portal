...
const EXAMS = [
  ...
  // 
  {
    ...
    duration: 60,
    questions: [
      { q: "The word \"Church\" is derived from the Greek word Ekklesia, which means:", options: ["Building","School","Assembly","Club"], answer: 2 },
      { q: "The Hebrew equivalent Qahal means:", options: ["The strong ones","The called out","The holy ones","The chosen ones"], answer: 1 },
      { q: "Where was the Church built through the agency of the Holy Spirit around A.D. 30?", options: ["Bethlehem","Nazareth","Upper Room in Jerusalem","Rome"], answer: 2 },
      { q: "Which Jewish festival was being celebrated when the Church was born?", options: ["Passover","Tabernacles","Pentecost","Purim"], answer: 2 },
      { q: "\"Pentecost\" is a Greek word meaning:", options: ["Fire","Forty","Fiftieth","Fifty-five"], answer: 2 },
      { q: "The Northern Kingdom of the Jews was taken into exile in 721 B.C. by the:", options: ["Babylonians","Assyrians","Persians","Romans"], answer: 1 },
      { q: "The Southern Kingdom (Judah) was taken into exile in 586 B.C. by the:", options: ["Greeks","Egyptians","Babylonians","Romans"], answer: 2 },
      { q: "Which Persian ruler allowed the Jews to return to their home country?", options: ["Darius","Xerxes","Cyrus","Artaxerxes"], answer: 2 },
      { q: "The Hebrew word for \"deliverer\" is Messiah, and the Greek word is:", options: ["Logos","Christos","Theos","Kyrios"], answer: 1 },
      { q: "The \"Diaspora\" refers to the Jews who:", options: ["Lived only in Jerusalem","Were taken into or lived in exile/dispersion","Became Roman soldiers","Rejected the Law"], answer: 1 },
      { q: "\"Hellenists\" were Grecian Jews who spoke which language?", options: ["Hebrew","Latin","Greek","Aramaic"], answer: 2 },
      { q: "The \"Synagogue\" is a Greek word meaning:", options: ["Temple","Altar","Meeting place","Holy house"], answer: 2 },
      { q: "Which Jewish sect did NOT believe in the resurrection, spirits, or angels?", options: ["Pharisees","Sadducees","Zealots","Essenes"], answer: 1 },
      { q: "The word \"Pharisee\" means:", options: ["United","Separated","Learned","Warrior"], answer: 1 },
      { q: "Which young Macedonian king conquered Palestine and spread Greek culture?", options: ["Philip II","Alexander the Great","Ptolemy","Seleucus"], answer: 1 },
      { q: "\"Hellenism\" refers to the:", options: ["Roman law","Jewish religion","Greek oriental way of life","Egyptian art"], answer: 2 },
      { q: "The Roman Governor of Judea during Jesus' earthly ministry was:", options: ["Herod the Great","Augustus Caesar","Pontius Pilate","Nero"], answer: 2 },
      { q: "The \"Pax Romana\" refers to the:", options: ["Roman war","Roman taxes","Peace of Rome","Roman religion"], answer: 2 },
      { q: "What practice was introduced by the Romans to consolidate power and unity?", options: ["Monotheism","Emperor worship","Circumcision","Fasting"], answer: 1 },
      { q: "\"Religio illicita\" means:", options: ["Legal religion","Illegal religion","New religion","State religion"], answer: 1 },
      { q: "Which Emperor falsely blamed Christians for the fire that destroyed half of Rome in A.D. 64?", options: ["Domitian","Trajan","Nero","Hadrian"], answer: 2 },
      { q: "The Bishop of Antioch who was thrown to wild beasts around A.D. 115 was:", options: ["Polycarp","Clement","Ignatius","Justin"], answer: 2 },
      { q: "Justin Martyr was a member of which group that wrote in defense of Christianity?", options: ["Pharisees","Monks","Apologists","Gnostics"], answer: 2 },
      { q: "The first Roman Emperor to become a Christian was:", options: ["Decius","Diocletian","Constantine","Valerian"], answer: 2 },
      { q: "What was the sign Constantine saw in a vision before his victory?", options: ["A dove","A lion","A flaming cross","An angel"], answer: 2 },
      { q: "The \"Edict of Milan\" (A.D. 313) declared that:", options: ["Persecution should increase","Persecution should cease throughout the empire","All Jews must leave Rome","Sunday is the only day for work"], answer: 1 },
      { q: "\"Monasticism\" is the movement of Christians who lived isolated lives in the:", options: ["Cities","Palaces","Desert","Temples"], answer: 2 },
      { q: "Who was the wealthy young Egyptian who became a leader of the desert hermits?", options: ["Benedict","Pachomius","Anthony","Origen"], answer: 2 },
      { q: "The \"Apostolic Fathers\" were writers regarded by the Church as:", options: ["Biological brothers of Jesus","Disciples of the Apostles","Roman Governors","Jewish Priests"], answer: 1 },
      { q: "The Didache is a handbook of:", options: ["Roman taxes","Christian instruction","Jewish history","Greek poetry"], answer: 1 },
      { q: "\"Canon\" is derived from a Greek word meaning:", options: ["Story","Standard or rule","Prayer","Song"], answer: 1 },
      { q: "Who first set forth the collection of the New Testament as it exists today in A.D. 367?", options: ["Augustine","Jerome","Athanasius","Polycarp"], answer: 2 },
      { q: "The test of \"Apostolicity\" meant a book was accepted if written by an Apostle or:", options: ["A Roman Emperor","A close associate of the Apostles","A Greek philosopher","A Jewish King"], answer: 1 },
      { q: "\"Martyrdom\" refers to the act of:", options: ["Winning an argument","Being killed for one's faith","Traveling to new lands","Building a church"], answer: 1 },
      { q: "The \"Donatist controversy\" was about how to treat those who:", options: ["Became wealthy","Lapsed during persecution","Refused to pay tithes","Moved to the desert"], answer: 1 },
      { q: "The \"Arian controversy\" was mainly doctrinal and concerned the:", options: ["Location of the church","Validity of baptism","Person of Christ","End of the world"], answer: 2 },
      { q: "Montanus was criticized because he claimed to be able to:", options: ["Heal the sick","Forgive sins","Read Greek","Rule Rome"], answer: 1 },
      { q: "\"Mithraism\" was a form of worship popular among:", options: ["Women","Children","Roman soldiers","Jewish Priests"], answer: 2 },
      { q: "The first Christian martyr was:", options: ["Peter","Paul","Stephen","James"], answer: 2 },
      { q: "Antioch was significant because it was where the disciples were first called:", options: ["Apostles","Saints","Christians","Hellenists"], answer: 2 },
      { q: "How many books are in the New Testament?", options: ["12","14","27","39"], answer: 2 },
      { q: "The \"Essenes\" were a sect devoted to holiness that lived in the:", options: ["Temple","Desert","Palace","Market"], answer: 1 },
      { q: "The \"Sanhedrin\" was the:", options: ["Roman Army","Jewish Choir","Judiciary arm of the government","Greek school"], answer: 2 },
      { q: "\"Ekklesia\" refers to an:", options: ["Altar","Offering","Assembly","Exile"], answer: 2 },
      { q: "\"Oral Tradition\" refers to the period when the New Testament was a matter of:", options: ["Written law","Oral discussion","Silent prayer","Secret signals"], answer: 1 },
      { q: "\"Soteriology\" is the doctrine of:", options: ["Angels","Salvation","Sin","Last things"], answer: 1 },
      { q: "Marcion's doctrine was rejected because he believed in:", options: ["No God","Two Gods (good and bad)","Many Gods","Only Jesus"], answer: 1 },
      { q: "Which city did Constantine build as the new Roman capital?", options: ["Alexandria","Ephesus","Constantinople","Carthage"], answer: 2 },
      { q: "\"Ascetic living\" involves:", options: ["Luxurious habits","Simple, rigorous, and self-denying life","Frequent travel","Political power"], answer: 1 },
      { q: "\"Athanasius\" set forth the collection of the New Testament in which year?", options: ["A.D. 100","A.D. 215","A.D. 367","A.D. 430"], answer: 2 }
    ]
  },
  ...
  // 
  {
    ...
    duration: 60,
    questions: [
      { q: "What is the primary focus of Church History according to the text?", options: ["Future predictions","Past events in relation to the present and future","Secular politics","Modern architecture"], answer: 1 },
      { q: "Which African country is identified as the home country of Simon, who carried the cross of Jesus?", options: ["Egypt","Cyrenaica (now Libya)","Sudan","Nigeria"], answer: 1 },
      { q: "Tradition holds that the Church in Egypt was established by which evangelist?", options: ["Luke","John Mark","Apollos","Philip"], answer: 1 },
      { q: "Who is referred to as Africa's first missionary?", options: ["Tertullian","Apollos","Cyprian","Augustine"], answer: 1 },
      { q: "In the 1st century, West African people were identified as what?", options: ["Bantu","Eastern Sudanic Languages Tribes","Punic","Berbers"], answer: 1 },
      { q: "The first entry of the Latin Church into Africa was due to the presence of:", options: ["French priests","Italian immigrants and soldiers","British sailors","German farmers"], answer: 1 },
      { q: "By 300 A.D., records show there were more than how many African bishops?", options: ["10","100","250","1,000"], answer: 2 },
      { q: "The 'Eclipse of the Church in Africa' was primarily caused by:", options: ["Natural disasters","Internal disunity, doctrinal controversies, and schisms","Lack of Bibles","Overpopulation"], answer: 1 },
      { q: "Who founded the schismatic movement in Egypt known as Melitianism?", options: ["Peter of Alexandria","Melitius","Arius","Origen"], answer: 1 },
      { q: "What schism originated in North Africa from the refusal to accept Bishop Caecilian?", options: ["Arianism","Donatism","Eutychism","Nestorianism"], answer: 1 },
      { q: "Who was the greatest of the early church fathers who argued against Donatism?", options: ["Clement","St. Augustine","Tertullian","Origen"], answer: 1 },
      { q: "In what century did the Muslims overcome the Greco-Roman ruling class in Africa?", options: ["5th","7th","10th","12th"], answer: 1 },
      { q: "Muhammad was born in which city around 570 A.D.?", options: ["Medina","Mecca","Jerusalem","Cairo"], answer: 1 },
      { q: "Muhammad referred to Christians as the people of the:", options: ["Sword","'Book'","Desert","Cross"], answer: 1 },
      { q: "To which city did Muhammad flee in 622 A.D. for safety?", options: ["Mecca","Medina","Damascus","Baghdad"], answer: 1 },
      { q: "The Arabs invaded Africa seven years after Muhammad's death in which year?", options: ["610","639","710","800"], answer: 1 },
      { q: "Which group in North Africa was most resistant to conversion by the Arabs?", options: ["Italians","Berbers","Greeks","Persians"], answer: 1 },
      { q: "The Portuguese explorer popularly called 'The Navigator' was:", options: ["Vasco da Gama","Prince Henry","Columbus","Diogo Gomez"], answer: 1 },
      { q: "What was a major commercial motive for the Portuguese exploration of West Africa?", options: ["Spices and Gold","Oil","Diamonds","Coal"], answer: 0 },
      { q: "The first Portuguese capture in Africa was which city in 1415?", options: ["Lagos","Ceuta","Accra","Dakar"], answer: 1 },
      { q: "In 1462, who was appointed by Pope Pius II as Prefect for Guinea?", options: ["A Jesuit priest","A Portuguese Franciscan","A Baptist minister","A Methodist deacon"], answer: 1 },
      { q: "The first missionary contacts with Benin were made about what year?", options: ["1400","1477","1600","1842"], answer: 1 },
      { q: "Which Itsekiri Prince was sent to Portugal for education and to be trained as a priest?", options: ["Sodeke","Prince Domingo","Sebastian","Behenoi"], answer: 1 },
      { q: "A major reason for the failure of Portuguese missions in West Africa was:", options: ["Too much funding","Language barrier and involvement in political affairs","High local literacy","Lack of ships"], answer: 1 },
      { q: "The English revival received its most vital stimulus from whose 'strange warming' of the heart?", options: ["Whitefield","John Wesley","Henry Venn","Robert Raikes"], answer: 1 },
      { q: "Which missionary society was founded in 1799?", options: ["SPG","CMS (Church Missionary Society)","SPCK","BMS"], answer: 1 },
      { q: "Who is often called the 'father of modern missions'?", options: ["John Wesley","William Carey","Samuel Crowther","Thomas Bray"], answer: 1 },
      { q: "The evangelical movement of the 1780s was marked by a desire for the abolition of:", options: ["Taxes","Slave Trade","Farming","Schools"], answer: 1 },
      { q: "What was the capital city of the Sierra Leone colony founded as a haven for freed slaves?", options: ["Badagry","Freetown","Accra","Monrovia"], answer: 1 },
      { q: "What does the 'Three Cs' doctrine stand for?", options: ["Cars, Coins, Clubs","Christianity, Commerce and Civilization","Cooking, Cleaning, Caring","Church, Choir, Community"], answer: 1 },
      { q: "Who authored the solution for Africa being 'the Bible and the plough'?", options: ["William Wilberforce","Sir Thomas Fowell Buxton","Henry Townsend","David Hinderer"], answer: 1 },
      { q: "The advent of the first English-speaking Christian Mission in Badagry took place in:", options: ["1800","1842","1860","1900"], answer: 1 },
      { q: "Who was the outstanding African Christian leader who became the first African Anglican bishop?", options: ["James Johnson","Samuel Ajayi Crowther","Isaac Oluwole","Mojola Agbebi"], answer: 1 },
      { q: "Which city became the center of the CMS mission in Yorubaland?", options: ["Lagos","Abeokuta","Ibadan","Oyo"], answer: 1 },
      { q: "The first newspaper ever printed in Nigeria (1859) was named:", options: ["Daily Times","Iwe Irohin Yoruba","The Guardian","Lagos Observer"], answer: 1 },
      { q: "Who is referred to as the real pioneer of Christianity in Osogbo?", options: ["David Hinderer","Revd. John Mackay","Henry Townsend","Mary Slessor"], answer: 1 },
      { q: "Mary Slessor is famous for stopping the ritualistic killing of what in Calabar?", options: ["Cats","Twins","Lions","Cattle"], answer: 1 },
      { q: "Thomas Birch Freeman was a pioneer missionary for which mission?", options: ["Anglican","Wesleyan Methodist","Catholic","Baptist"], answer: 1 },
      { q: "The Southern American Baptist Mission arrived in Yorubaland in:", options: ["1840","1850","1870","1890"], answer: 1 },
      { q: "The first resident Catholic priest in Nigeria, arriving in 1863, was:", options: ["Father Lutz","Father Piere Bouche","Father Borghero","Bishop Shanahan"], answer: 1 },
      { q: "What system of administration did Lord Lugard introduce in Northern Nigeria?", options: ["Direct Rule","Indirect Rule","Military Rule","Democracy"], answer: 1 },
      { q: "Why did Christian missions have very little success in Northern Nigeria in the 19th Century?", options: ["Lack of water","Firmly established Islam and colonial restrictions","No roads","Small population"], answer: 1 },
      { q: "What term is used to describe African nationalism expressed through the church?", options: ["Anglicanism","Ethiopianism","Methodism","Catholicism"], answer: 1 },
      { q: "Rev. Henry Venn advocated for a church that was self-supporting, self-governing, and:", options: ["Self-funding","Self-extending","Self-centered","Self-made"], answer: 1 },
      { q: "Who was the spokesman of the Native Pastorate in Sierra Leone against European opposition?", options: ["Samuel Crowther","Rev. James Johnson","Henry Townsend","David Hinderer"], answer: 1 },
      { q: "The Bethel African Church seceded from which Anglican church in 1901?", options: ["Ake Church","St. Paul's Church, Breadfruit Street","First Baptist Church","Wesley Cathedral"], answer: 1 },
      { q: "Which church seceded from the First Baptist Church, Lagos, in 1888?", options: ["United Native Methodist Church","Ebenezer Baptist Church","Bethel African Church","St. Paul's Breadfruit"], answer: 1 },
      { q: "The prestigious educational institution Fourah Bay College was founded in:", options: ["1800","1827","1876","1901"], answer: 1 },
      { q: "What was a major reason for slow church growth in West Africa?", options: ["Too many Bibles","The 'School Approach' to evangelism","Good weather","Lack of teachers"], answer: 1 },
      { q: "Which 1841 expedition was forced by Buxton on the British government?", options: ["Benin Expedition","Niger Expedition","Nile Expedition","Sahara Expedition"], answer: 1 }
    ]
  },
  ...
  // 
  {
    ...
    duration: 60,
    questions: [
      { q: "What does the name \"Genesis\" mean?", options: ["Law","Origin or Beginning","End","Covenant"], answer: 1 },
      { q: "Who is the traditionally accepted author of the Pentateuch?", options: ["Abraham","David","Moses","Joshua"], answer: 2 },
      { q: "The name \"Exodus\" means:", options: ["Law-giving","A going out","Counting","Holiness"], answer: 1 },
      { q: "Which book contains instructions for priestly duties and holy living?", options: ["Numbers","Leviticus","Deuteronomy","Joshua"], answer: 1 },
      { q: "\"Holiness\" is mentioned more in this book than any other in the Bible:", options: ["Genesis","Leviticus (152 times)","Hebrews","Romans"], answer: 1 },
      { q: "The book of Numbers records the story of:", options: ["The creation","How Israel prepared to enter the Promised Land","The life of Solomon","The birth of Jesus"], answer: 1 },
      { q: "\"Deuteronomy\" comes from Greek words meaning:", options: ["First Law","Second Law","Holy Law","God's Law"], answer: 1 },
      { q: "Who led Israel into the Promised Land after Moses died?", options: ["Caleb","Joshua","Aaron","Gideon"], answer: 1 },
      { q: "The book of Judges deals with a pattern of Israel turning from God and being given a:", options: ["King","Deliverer/Judge","New country","Map"], answer: 1 },
      { q: "The story of Ruth takes place during the period of the:", options: ["Kings","Exile","Judges","Apostles"], answer: 2 },
      { q: "Who was the last judge of Israel and anointed the first two kings?", options: ["Eli","Samuel","Saul","Nathan"], answer: 1 },
      { q: "The books of Kings describe the division of the nation into:", options: ["Ten parts","Two kingdoms (Israel and Judah)","Three states","Twelve districts"], answer: 1 },
      { q: "\"Chronicles\" were written from a:", options: ["Military perspective","Priestly perspective","Secular perspective","Gentile perspective"], answer: 1 },
      { q: "Ezra records the history of the Jewish people returning from:", options: ["Egypt","Rome","Babylon","Greece"], answer: 2 },
      { q: "Nehemiah returned to Jerusalem to rebuild the:", options: ["Temple","City walls","Palace","Altar"], answer: 1 },
      { q: "Which book is unusual for not mentioning the name of God in its original language?", options: ["Ruth","Esther","Job","Jonah"], answer: 1 },
      { q: "The book of Job addresses the difficult question:", options: ["How was the earth made?","Why do the righteous suffer?","Who is the greatest?","When will the end come?"], answer: 1 },
      { q: "Who wrote the largest number of Psalms?", options: ["Solomon","Moses","David (73 psalms)","Asaph"], answer: 2 },
      { q: "The purpose of the book of Proverbs is to:", options: ["Sing songs","Apply divine wisdom to daily life","Record history","Predict the future"], answer: 1 },
      { q: "Ecclesiastes concludes that the entire duty of man is to:", options: ["Be rich","Fear God and obey His commandments","Study hard","Travel the world"], answer: 1 },
      { q: "The Song of Solomon is primarily a collection of:", options: ["War stories","Love poems","Legal codes","Historical dates"], answer: 1 },
      { q: "Isaiah is famously known for his prophecies concerning the:", options: ["Flood","Building of the walls","Messiah","Fall of Rome"], answer: 2 },
      { q: "Jeremiah ministered during the decline and fall of:", options: ["Israel","Judah","Egypt","Persia"], answer: 1 },
      { q: "\"Lamentations\" contains poems expressing sorrow over the fall of:", options: ["Babylon","Jerusalem","Nineveh","Tyre"], answer: 1 },
      { q: "Ezekiel prophesied to the Jews who were:", options: ["In Egypt","In captivity in Babylon","In Jerusalem","In Rome"], answer: 1 },
      { q: "The book of Daniel is known for its:", options: ["Simple recipes","Apocalyptic visions","Detailed genealogies","Marriage advice"], answer: 1 },
      { q: "Hosea's life was used to illustrate God's love for his:", options: ["Obedient people","Sinful people","Angels","Enemies"], answer: 1 },
      { q: "Joel urged the people to \"return to the Lord\" with:", options: ["Money","Fasting, weeping, and mourning","New clothes","Loud singing"], answer: 1 },
      { q: "Amos pronounced judgment on Israel for their complacency and:", options: ["Intelligence","Oppression of the poor","Hard work","Kindness"], answer: 1 },
      { q: "The book of Obadiah is concerned with God's judgment on:", options: ["Egypt","Edom","Moab","Philistia"], answer: 1 },
      { q: "Jonah was sent to preach to the city of:", options: ["Joppa","Nineveh","Jerusalem","Rome"], answer: 1 },
      { q: "Micah taught that God wants us to be fair, just, merciful, and:", options: ["Strong","Walk humbly with God","Wealthy","Famous"], answer: 1 },
      { q: "Nahum predicted the destruction of:", options: ["Jerusalem","Nineveh","Babylon","Egypt"], answer: 1 },
      { q: "Habakkuk shows that God is still in control despite the:", options: ["Goodness of people","Apparent triumph of evil","Lack of rain","End of the world"], answer: 1 },
      { q: "Zephaniah prophesied during the reign of King:", options: ["Saul","Josiah","Ahab","Herod"], answer: 1 },
      { q: "Haggai called the people to complete the rebuilding of the:", options: ["Palace","Temple","Walls","Houses"], answer: 1 },
      { q: "Zechariah's chief concern was to prepare people for the era of the:", options: ["Flood","Messiah","Kings","Exile"], answer: 1 },
      { q: "Malachi confronted the people with their neglect of the:", options: ["Army","Temple","Schools","Markets"], answer: 1 },
      { q: "Matthew's Gospel was written especially to prove to the:", options: ["Romans that Jesus was a citizen","Jews that Jesus is the Messiah","Greeks that Jesus was a philosopher","Egyptians that Jesus was a god"], answer: 1 },
      { q: "Mark's Gospel is noted for recording more:", options: ["Speeches than any other","Miracles than any other","Genealogies than any other","Laws than any other"], answer: 1 },
      { q: "Luke, the author of the third Gospel, was a:", options: ["Tax collector","Doctor","Fisherman","Tentmaker"], answer: 1 },
      { q: "John's Gospel was written so that you might \"believe\" and have:", options: ["Money","Life","Fame","Control"], answer: 1 },
      { q: "The book of Acts is the connecting link between:", options: ["Creation and the Fall","Christ's life and the life of the Church","The Old Testament and the Exile","Heaven and Hell"], answer: 1 },
      { q: "Romans provides a carefully developed exposition of the:", options: ["Roman law","Christian gospel","History of Spain","Temple ritual"], answer: 1 },
      { q: "1 Corinthians was written to offer solutions to problems in a:", options: ["Perfect society","Corrupt society","Desert","Monastery"], answer: 1 },
      { q: "Galatians refutes the \"Judaizers\" and calls Christians to:", options: ["Slavery","Freedom in Christ","The Old Law","Silence"], answer: 1 },
      { q: "Ephesians explains the nature and purpose of the:", options: ["Law","Church","Solar system","Human body"], answer: 1 },
      { q: "Philippians emphasizes that true joy comes from:", options: ["Gifts","Jesus Christ alone","Hard work","Being a prisoner"], answer: 1 },
      { q: "Colossians was written to show that believers have everything they need in:", options: ["Rome","Christ","Knowledge","Philosophy"], answer: 1 },
      { q: "Philemon was written to convince a master to forgive his:", options: ["Son","Runaway slave (Onesimus)","Neighbor","Wife"], answer: 1 }
    ]
  },
  ...
  // 
  {
    ...
    duration: 60,
    questions: [
      { q: "What is the Greek word for the \"called out\" assembly?", options: ["Logos","Ekklesia","Qahal","Pragmateuomai"], answer: 1 },
      { q: "In 1 Corinthians 12:28, administration is identified as a:", options: ["Burden","Secular duty","Spiritual gift","Human invention"], answer: 2 },
      { q: "Who is considered the father of modern management theory?", options: ["Apostle Paul","Henry Fayol","Wayne Grudem","Titus"], answer: 1 },
      { q: "Which management principle states that employees should receive orders from only one superior?", options: ["Division of Labour","Scalar Chain","Unity of Command","Equity"], answer: 2 },
      { q: "\"Theocracy\" literally means:", options: ["Rule of the people","Rule of God","Rule of a small class","Rule of a king"], answer: 1 },
      { q: "The Greek word Pragmateuomai, translated as \"occupy,\" relates to:", options: ["Emotional feelings","Future dreams","Task performance and practical exercise","Stationary waiting"], answer: 2 },
      { q: "A Christian steward is described as a:", options: ["Novice disciple","Slave to the church","Graduate disciple with responsibilities","Secular employee"], answer: 2 },
      { q: "Which of the following is an \"Incommunicable\" attribute of God?", options: ["Love","Self-existence","Faithfulness","Mercy"], answer: 1 },
      { q: "The \"Scalar Chain\" principle in management refers to:", options: ["Teamwork","Equality for all","A chain of superiors from highest to lowest ranks","Constant change of leadership"], answer: 2 },
      { q: "The primary law that triggers the flow of Kingdom Wealth is:", options: ["Hard work","Giving and receiving","Saving and hoarding","Bargaining"], answer: 1 },
      { q: "How many people are required to sign the marriage register in an RCCG service?", options: ["Two","Four","Six","Eight"], answer: 2 },
      { q: "In the organizational information structure, the top layer is the:", options: ["Operational level","Tactical level","Strategic level","Technical level"], answer: 2 },
      { q: "\"Espirit de corps\" emphasizes the need for:", options: ["Individualism","Teamwork and communication","Discipline","Higher pay"], answer: 1 },
      { q: "What is the biblical benchmark for family provision mentioned in Module XII?", options: ["100% of income","Borrowing for luxury","Current provision for the family","Accumulating debt"], answer: 2 },
      { q: "Which type of data in information management is numerical?", options: ["Qualitative","Quantitative","Subjective","Raw"], answer: 1 },
      { q: "Effective Christian communication must be verbal, adequate, loving, and:", options: ["Secret","Lengthy","Truthful","Complex"], answer: 2 },
      { q: "Which Bible book is used to define \"Ecclesiology\"?", options: ["Genesis","Ephesians","Job","Malachi"], answer: 1 },
      { q: "A \"Constraint\" in the decision-making process is a factor like:", options: ["Excess time","Lack of funds","Perfect knowledge","No boundaries"], answer: 1 },
      { q: "According to Module XV, unresolved difficulties in a church usually lead to:", options: ["Growth","Wealth","Underlying tension and church splits","Better singing"], answer: 2 },
      { q: "Which archangel held the portfolio of \"Information\"?", options: ["Michael","Gabriel","Lucifer","Raphael"], answer: 1 },
      { q: "Kingdom wealth operates on the law of:", options: ["Chance","Theft","Obedience to God","Scarcity"], answer: 2 },
      { q: "The \"Model\" in decision-making represents a description of:", options: ["The pastor","The problem","The solution","The future"], answer: 1 },
      { q: "\"Division of Labour\" was utilized by the early disciples in:", options: ["John 3:16","Acts 6:1-7","Revelation 1:1","Genesis 1:1"], answer: 1 },
      { q: "A Church Administrator must be \"Change Oriented,\" which means:", options: ["Changing the Bible","Changing God","Conscious of and willing to adapt to environmental changes","Never changing plans"], answer: 2 },
      { q: "\"Management Information\" should help a church:", options: ["Hide from the world","Identify prime locations for new parishes","Buy more cars for leaders","Ignore community needs"], answer: 1 },
      { q: "Which quality of a steward refers to \"keeping a good name\"?", options: ["Wealth","Integrity","Speed","Force"], answer: 1 },
      { q: "The world's financial system is built on the concept of:", options: ["Abundance","Scarcity","Giving","Faith"], answer: 1 },
      { q: "Which parable illustrates the \"reckoning\" of a steward's task?", options: ["The Sower","The Prodigal Son","The Ten Pounds","The Mustard Seed"], answer: 2 },
      { q: "\"Unity of Direction\" means a group of activities with the same objective must have:", options: ["Many heads","One head and one plan","No plan","Conflicting goals"], answer: 1 },
      { q: "Spiritual laws, such as the \"Law of the Blood,\" cannot be:", options: ["Followed","Believed","Empirically tested","Found in the Bible"], answer: 2 },
      { q: "According to Titus 1:7, a bishop must be blameless as a:", options: ["Sinner","Steward of God","King","Businessman"], answer: 1 },
      { q: "A manager's authority should be commensurate with his:", options: ["Salary","Responsibility","Age","Car"], answer: 1 },
      { q: "Information \"Saves\" because our whole life is hinged on it, according to:", options: ["Matthew 6","Hosea 4:6","John 1","Psalm 23"], answer: 1 },
      { q: "\"Optimization\" in decision-making involves selecting the:", options: ["Worst solution","Best or optimum solution","First idea heard","Most expensive option"], answer: 1 },
      { q: "The first duty of a steward is to take:", options: ["Money","\"Egypt\" out of themselves","A vacation","Control of others"], answer: 1 },
      { q: "In the \"Moral Argument\" for God, man is seen as having:", options: ["No purpose","Conscience","Total control","Infinite knowledge"], answer: 1 },
      { q: "\"Centralisation\" refers to the degree to which:", options: ["People are fired","Authority is concentrated or dispersed","Buildings are built","Offerings are collected"], answer: 1 },
      { q: "\"Data\" are considered:", options: ["Finished reports","Raw materials from which information is derived","Divine revelations only","Useless facts"], answer: 1 },
      { q: "The Hebrew word Qahal means:", options: ["Holy","Power","The called out","To build"], answer: 2 },
      { q: "\"Equity\" in management combines kindliness and:", options: ["Anger","Justice","Fear","Wealth"], answer: 1 },
      { q: "Who must a steward be loyal to first?", options: ["The government","God and His Christ","The family","The bank"], answer: 1 },
      { q: "A \"Model\" in decision-making can be:", options: ["Only a physical object","Quantitative or qualitative","Only for fashion","Ignored by managers"], answer: 1 },
      { q: "\"Initiative\" involves the thinking out and:", options: ["Forgetting a plan","Execution of a plan","Stealing a plan","Mocking a plan"], answer: 1 },
      { q: "\"Tithing\" is described as the:", options: ["Only thing God wants","Minimum testimony to God's ownership","Voluntary gift","Replacement for faith"], answer: 1 },
      { q: "\"Information Objectives\" are statements that tell:", options: ["Lies","What information you want to know","Who to fire","The future perfectly"], answer: 1 },
      { q: "What \"triggers\" the flow of Kingdom wealth?", options: ["Tears","The Law of Giving and Receiving","Fasting alone","Complaining"], answer: 1 },
      { q: "The \"Environment\" in information management for ministry includes:", options: ["Only physical features","Territorial spirits, culture, and physical features","No spiritual factors","Only legal matters"], answer: 1 },
      { q: "\"Order\" in management means:", options: ["Constant chaos","A place for everything and everything in its place","Buying everything new","Giving orders harshly"], answer: 1 },
      { q: "\"Decision making\" is viewed as a:", options: ["Purely emotional process","Rational information using process","Random guess","Waste of time"], answer: 1 },
      { q: "Who gave Moses vital \"management information\" regarding delegation?", options: ["Aaron","His father-in-law (Jethro)","Joshua","Pharaoh"], answer: 1 }
    ]
  },
  ...
  // 
  {
    ...
    duration: 60,
    questions: [
      { q: "The word \"Pneumatology\" is derived from the Greek words pneumatos and:", options: ["Theos","Bios","Logos","Ethos"], answer: 2 },
      { q: "The Greek word hagios, often added to pneumatos, means:", options: ["Power","Wind","Holy, sanctified, or divine","Dove"], answer: 2 },
      { q: "In the Trinity, the Holy Spirit is recognized as the:", options: ["First Person","Second Person","Third Person","Only Person"], answer: 2 },
      { q: "At the baptism of Jesus, the Holy Spirit descended in the form of a:", options: ["Flame","Dove","Cloud","Eagle"], answer: 1 },
      { q: "The term Paracletos (Comforter) refers to someone called to:", options: ["Judge a person","Stand by someone to help","Punish a person","Lead a choir"], answer: 1 },
      { q: "Which of the following is a personal attribute of the Holy Spirit?", options: ["He is a mere influence","He possesses intelligence and will","He is an impersonal force","He has no emotions"], answer: 1 },
      { q: "According to Acts 5:3-4, lying to the Holy Spirit is the same as lying to:", options: ["An Angel","The Pastor","God","Yourself"], answer: 2 },
      { q: "\"Omnipresent\" means the Holy Spirit is:", options: ["All-powerful","All-knowing","Present everywhere at the same time","Eternal"], answer: 2 },
      { q: "The Holy Spirit's work in creation identifies Him as the:", options: ["Originating Cause","Instrumental Cause","Dynamic Cause","Final Cause"], answer: 2 },
      { q: "Divine Inspiration is the work of the Spirit enabling people to receive and record:", options: ["Secular history","Human opinions","God's special revelation without error","Personal dreams"], answer: 2 },
      { q: "In the Old Testament, the Holy Spirit \"came upon\" Othniel to empower him as a:", options: ["King","Judge","Priest","Carpenter"], answer: 1 },
      { q: "Who was the craftsman filled with the Spirit for work on the Tabernacle?", options: ["Moses","Aaron","Bezaleel","Joshua"], answer: 2 },
      { q: "Jesus' human nature was conceived by the action of the:", options: ["Archangel Michael","Disciples","Holy Spirit","Pharisees"], answer: 2 },
      { q: "When did Jesus receive the Holy Spirit's enablement for His public ministry?", options: ["At birth","At His baptism","After the resurrection","In the Garden of Gethsemane"], answer: 1 },
      { q: "The Holy Spirit \"participated\" in which event involving Jesus' body?", options: ["The burial","The walk to Calvary","The physical resurrection from the dead","The temptation"], answer: 2 },
      { q: "How many disciples were filled with the Holy Spirit on the Day of Pentecost?", options: ["11","70","120","3,000"], answer: 2 },
      { q: "The term glossolalia refers to:", options: ["Bible study","Speaking with other tongues","Fasting","Silent prayer"], answer: 1 },
      { q: "The Holy Spirit \"restrains\" lawlessness in the world using:", options: ["Only the weather","Human governments and godly people","Only Angels","No one"], answer: 1 },
      { q: "The Holy Spirit convicts the world of sin, judgment, and:", options: ["Wealth","History","Righteousness","Politics"], answer: 2 },
      { q: "\"Regeneration\" by the Holy Spirit occurs at the time of:", options: ["Baptism in water","Salvation","Death","Marriage"], answer: 1 },
      { q: "The Holy Spirit \"seals\" the believer as a mark of:", options: ["Sin","Ownership and security","Perfection","Poverty"], answer: 1 },
      { q: "The Holy Spirit helps believers in prayer because He understands our:", options: ["Bank accounts","Weaknesses","Ambitions","Dreams"], answer: 1 },
      { q: "Which experience fills believers with power for ministry and service?", options: ["Naming ceremony","Baptism of the Holy Spirit","Church membership","Graduation"], answer: 1 },
      { q: "A primary evidence of the Holy Spirit Baptism in the early church was:", options: ["Wealth","Silence","Speaking in tongues","Fasting"], answer: 2 },
      { q: "The \"Fruit of the Spirit\" is singular in Galatians 5:22 because it is:", options: ["Small","Unified in purpose and direction","Only for Pastors","Only one virtue"], answer: 1 },
      { q: "Which level of love is described as God's kind of love?", options: ["Filial","Eros","Agape","Philia"], answer: 2 },
      { q: "\"Long-suffering\" is another word for:", options: ["Singing","Patience","Crying","Running"], answer: 1 },
      { q: "\"Meekness\" is defined as the opposite of:", options: ["Joy","Peace","Pride","Faith"], answer: 2 },
      { q: "\"Temperance\" is also known as:", options: ["Boldness","Self-control","Anger","Speed"], answer: 1 },
      { q: "How many sub-groups are the nine Spiritual Gifts divided into?", options: ["Two","Three","Four","Five"], answer: 1 },
      { q: "The \"Word of Wisdom\" is a supernatural insight into the:", options: ["Past","Present","Future will and purpose of God","Human brain"], answer: 2 },
      { q: "Which gift reveals the mind of God for the past and the present?", options: ["Word of Wisdom","Word of Knowledge","Faith","Healing"], answer: 1 },
      { q: "\"Discerning of Spirits\" allows a believer to detect:", options: ["Only good spirits","The realm of spirits and their plans","Future dates","Buried gold"], answer: 1 },
      { q: "\"Interpretation of Tongues\" makes known what is uttered in:", options: ["A foreign country","Spiritual tongue","Sign language","Code"], answer: 1 },
      { q: "The gift of \"Faith\" for a specific need is described as:", options: ["Human reasoning","Supernatural ability to believe God","Doubt","A long process"], answer: 1 },
      { q: "The floating of the axe head in II Kings 6 is an example of:", options: ["Wisdom","Knowledge","Working of Miracles","Prophecy"], answer: 2 },
      { q: "The word \"Apostle\" (apostolos) actually means:", options: ["One who is rich","One who is sent","One who is old","One who stays at home"], answer: 1 },
      { q: "A \"Prophet\" in the New Testament has a two-fold operation: Forthtelling and:", options: ["Backstabbing","Writing","Foretelling","Singing"], answer: 2 },
      { q: "The office of \"Pastor\" is likened to a:", options: ["Fisherman","Shepherd","Soldier","Judge"], answer: 1 },
      { q: "\"Evangelist\" (Euangelistes) means a:", options: ["Singer of songs","Preacher or messenger of good news","Resident priest","Tax collector"], answer: 1 },
      { q: "The relationship of the five-fold ministries says the Pastor is needed to:", options: ["Gather","Guide","Guard","Ground"], answer: 2 },
      { q: "The teacher is needed to:", options: ["Govern","Guard","Ground","Gather"], answer: 2 },
      { q: "\"Eschatology\" is the study of:", options: ["Plants","Animals","Future events/last things","Stars"], answer: 2 },
      { q: "The major role of the Holy Spirit at the Parousia will be the:", options: ["Creation","Rapture","Flood","Crucifixion"], answer: 1 },
      { q: "Which biblical figure was taken out by rapture before the flood judgment?", options: ["Noah","Abraham","Enoch","Moses"], answer: 2 },
      { q: "Elijah was caught up to heaven by a:", options: ["Cloud","Dove","Chariot of fire","Mountain"], answer: 2 },
      { q: "The Holy Spirit is susceptible to \"personal treatment,\" meaning He can be:", options: ["Broken","Grieved or lied to","Killed","Bought"], answer: 1 },
      { q: "\"Agape\" love is:", options: ["Selfish","The unconditional love of God","Romantic love","Only for family"], answer: 1 },
      { q: "\"Working of Miracles\" is the temporary suspension of:", options: ["The Church","The ordinary course of nature","Prayer","Time"], answer: 1 },
      { q: "The Holy Spirit's \"Divine Attributes\" include being \"Omniscient,\" which means:", options: ["All-powerful","All-knowing","Ever-present","Eternal"], answer: 1 }
    ]
  },
  ...
  // 
  {
    ...
    duration: 60,
    questions: [
      { q: "The word 'profession' has its root meaning in the word 'professio'. What does this mean?", options: ["To perform on stage or in public","To profess or confess — a calling requiring specialised knowledge and often intensive preparation including specialised instruction in skills and methods","To teach or instruct others in academic subjects","To preach the gospel publicly without training"], answer: 1 },
      { q: "According to Module I, what are the three basic qualifications for the ministry?", options: ["Good education, charisma and financial security","Born again, holiness (Holy Ghost cannot develop a practical thing in such a person's life), and ability to develop sensitivity to the voice of God and a pure heart","Formal ordination, fluency in Hebrew and Greek, and church membership","A degree in theology, experience in business and a good singing voice"], answer: 1 },
      { q: "What are the diverse ways God reveals His will to those He calls into ministry?", options: ["Only through dreams and fasting","Theophany, Audible Voice, Vision, Angels, Holy Spirit and Guidance","Only through the written Bible","Only through the laying on of hands by a bishop"], answer: 1 },
      { q: "What is a THEOPHANY as described in the course material?", options: ["A vision seen only at night during deep sleep","The physical appearance of God the Son, the second person in trinity, in human form (Genesis 18:1-8, 17, 33)","An audible voice that speaks to the prophet in a loud thundering tone","A special type of dream that only prophets receive"], answer: 1 },
      { q: "According to Module I, what does it mean when God guides through circumstance?", options: ["That God removes all obstacles so the path is always smooth","God presents His chosen ones with circumstances; at His appointed time, doors of opportunity will open on their own volition — God will open different doors to confirm His guidance, and the vessel is to wait and walk in His appointed time","The minister should only preach when invited by other churches","God's guidance through circumstance means that every closed door is a sign to stop"], answer: 1 },
      { q: "From what Greek word is 'Homiletics' derived, and what does it signify?", options: ["From the Greek 'homilia' — meaning a public lecture or a theatrical performance","From the Greek word 'homilia' which signifies either a mutual talk and conversation or a set of discourse — Homiletics is the art and science of preaching, delivering the prepared sermon and preserving the sermon as defined simply as the art and science of the preparation, presentation and preservation of Bible messages or sermons","From the Latin word 'hominus' meaning human being","From the Hebrew word 'homah' meaning a wall of defence"], answer: 1 },
      { q: "What is the purpose of Homiletics as stated in the course?", options: ["Only to entertain the congregation with beautiful sermons","It shows us the scientific means of preparing a sermon or a gospel address; it tells us the effective way to deliver a sermon that has been prepared; and it also teaches us how to preserve a sermon that has already been delivered meticulously","To teach ministers how to use musical instruments","To help preachers memorise Bible verses verbatim"], answer: 1 },
      { q: "How is Preaching defined in Module III?", options: ["Preaching is a political speech given in the church during elections","Preaching is the proclamation of the good news of salvation through man to men. It is the proclamation of the Word of God with a view to bringing salvation to men and for building up faith of men in a Man and a Message — the Man Jesus Christ and the message from God","Preaching is a formal academic lecture on theology and church history","Preaching is the act of singing hymns and leading congregational worship"], answer: 1 },
      { q: "What is Exhortation as distinguished from preaching in the course material?", options: ["Exhortation is a type of sermon that is always longer and more detailed than a regular sermon","Exhortation is a less formal address made by a preacher to his congregation to act upon the truth they have heard from him — it is a skill, the best way of making an altar call and an important part of a soul-winning service like an altar call in preaching","Exhortation refers exclusively to the singing of praise and worship songs","Exhortation is reading the Bible aloud to the congregation without commentary"], answer: 1 },
      { q: "What is the purpose of preaching according to Module III?", options: ["To showcase the preacher's intellectual and literary abilities","Preaching is confined to the proclamation of the gospel of Jesus Christ — its purpose is to get men saved, sanctified and be prepared for heaven; it aims at getting men to turn from sin to righteousness","To raise funds for the church building projects","To entertain churchgoers with motivational speeches"], answer: 1 },
      { q: "How is a preacher described in Module IV?", options: ["A preacher is primarily an entertainer and public speaker hired by the church","A preacher is a man of God, an instructor and messenger of the Almighty, a public instructor, a leader, a friend of God and the most proper person to communicate the mind of God to man both with respect to the present and the future","A preacher is any Christian who reads the Bible publicly","A preacher is a person with the highest level of formal education in theology"], answer: 1 },
      { q: "What does the course say about the preacher's personality?", options: ["A preacher should be an imitator and actor, copying other well-known preachers","A preacher must not be an imitator by avoiding being someone else — rather he should be at his best always and never appear as an actor or pretender; he must be well trained in the art of communicating the mind of God to many always","A preacher's personality is not relevant as long as the message is biblically sound","A preacher must always appear very stern and serious, never jovial or warm"], answer: 1 },
      { q: "List the key personal qualifications of a preacher from the course material.", options: ["He must be wealthy, have a large congregation and hold a PhD in theology","He must be blameless and perfect in love — husband of one wife, not greedy of filthy lucre, not a boxer, not someone who beats his wife at home, not covetous, ruling his house well; he must be a self-disciplined man; a preacher is a minister of God Almighty","He must be born outside Nigeria and have studied in Europe or America","He must have a large social media following and be well known in public"], answer: 1 },
      { q: "What is the main problem of a preacher as identified in Module IV?", options: ["Finding a large enough church building","His sermon — what to speak about; the preacher must have the main theme or the central point of his message and must have succeeded in informing his congregation on a specific topic before a sermon is said to have benefitted them all","Raising enough money to support his ministry","Getting enough people to attend church on Sundays"], answer: 1 },
      { q: "According to the course, what are the key attributes of the sermon of a God-sent preacher?", options: ["The sermon must be long, eloquent and drawn from international news","The sermons must be messages tending to save sinners, sanctify, strengthen and build up believers for godly assignments; sermons must be God's own truth with no invention, fad, fallacy or modernism; themes must be divinely suggested for the congregation's particular time because only God knows what His people need","Sermons must be based entirely on the preacher's personal experiences","The sermon must last at least two hours to be spiritually effective"], answer: 1 },
      { q: "To what is a preacher likened in Module V regarding the gathering of sermon materials?", options: ["A farmer who harvests crops in their season","An architect whose responsibility is to erect a suitable structure out of available material — a preacher may decide to build a prison, a palace or a mansion from the available material he has; a preacher can be likened to an architect","A soldier who fights with whatever weapons are at hand","A student who borrows notes from other students"], answer: 1 },
      { q: "What is the primary source of sermon materials according to the course?", options: ["Newspapers and social media platforms","The Text — sermon materials can be obtained from the text via revelation from God, inspiration or divine illumination on the passage read","Books written by famous pastors and evangelists","Personal life experiences and stories from the congregation"], answer: 1 },
      { q: "What is an ANECDOTE as defined in Module V?", options: ["A long theological argument used to prove a doctrinal point","A short interesting or amusing narrative of a real person or event","A verse of scripture read at the beginning of a sermon","A formal introduction used to open every church service"], answer: 1 },
      { q: "Where can anecdotes be found, according to the course material?", options: ["Only in the Old Testament and Jewish history books","From the Holy Bible, newspapers and magazines, local history, ancient and modern history such as Romans, Greek and English history","Exclusively from foreign missionary journals","Only from the biographies of well-known evangelists"], answer: 1 },
      { q: "Why must a preacher always be prepared to preach?", options: ["So he can preach for as long as possible without stopping","Because he might be called to preach at a very short notice — a preacher should be prepared to preach at all times","So he can impress the church leadership with his knowledge","Because unprepared preachers always preach shorter sermons"], answer: 1 },
      { q: "What does the course identify as the FIRST rule in preparation for preaching?", options: ["Read as many books as possible before Sunday","Prepare your message immediately after the last sermon has been delivered — do not wait until the last minute or dying moment before scrambling for your next sermon","Consult other pastors about the theme of your next sermon","Write out your sermon word-for-word before the service"], answer: 1 },
      { q: "What does the course say about prayerlessness in sermon preparation?", options: ["Prayerlessness only affects newly ordained ministers","Prayerlessness produces unsuccessful sermons which gives birth to businesses that take much of the minister's time — be diligent, as it is not good for a minister to have other businesses that rob him of his time for prayer and sermon preparation","Prayerlessness is acceptable if the preacher is well educated","Prayerlessness only becomes a problem during special fasting seasons"], answer: 1 },
      { q: "How should the pulpit be situated according to Module VI?", options: ["The pulpit must be at the back of the church so that the preacher faces away from the congregation","The pulpit must be well situated — placed in a way that most members (if not all) of the congregation can see the preacher while preaching; it is regarded as a sacred place and the preacher must give due respect and honour to the pulpit; a preacher is not permitted to lean on the pulpit","The pulpit should be movable and placed wherever the preacher feels comfortable","The pulpit should always be elevated more than five metres above the congregation"], answer: 1 },
      { q: "What factors are taken note of in practical preaching according to the course?", options: ["Only the length of the sermon and the number of scriptures quoted","Opening prayer, relevant songs, sermon divisions, language used, use of illustration, audibility, the tempo of the preacher's voice, the preacher's comportment, appearance, use of other relevant Bible references, use of the pulpit, the sermon proper, applicability, conclusion, altar call, closing prayer, time management and the link between the preacher and his/her interpreter (if any)","Only the number of people in the congregation and the offering received","Only the appearance of the preacher and the duration of worship before the sermon"], answer: 1 },
      { q: "What does the course say is the greatest factor in a sermon's sale or appeal?", options: ["The length of the sermon","The theme — a wisely chosen theme has much to do with the interest of the sermon; just as the title of a book sometimes forms the sale of it, the theme must however be admitted that a wisely chosen theme should not be presented with dignity","The number of Bible verses quoted","The reputation and fame of the preacher"], answer: 1 },
      { q: "What does the course advise about the need to KNOW YOUR THEME THOROUGHLY?", options: ["You only need to know the first and last point of your theme","This does not mean that you must know absolutely everything connected with the theme — the preacher must have a clear, definite, intelligent and master grasp of the subject matter; the preacher must allow the theme to revolve more in his mind and preach better if he or she allows the theme to fully absorb his mind, masters it and preaches it","The preacher must memorise every detail of the theme from at least ten commentaries","Knowing your theme thoroughly means preaching above the head of the congregation"], answer: 1 },
      { q: "What is the difference between THEME and TITLE in Homiletics?", options: ["They are exactly the same thing and can be used interchangeably","Theme and title are not the same — the theme is the general idea while the title is the specific idea; in Homiletics, theme and title are not the same but the theme is an expression of the specific idea same as topic, while theme is an expression of a specific idea","The title is always longer than the theme","The theme refers only to Old Testament subjects while the title covers New Testament topics"], answer: 1 },
      { q: "What are the qualities of a good TITLE for a sermon according to the course?", options: ["It must be long, complex and use difficult theological vocabulary","It must be short and make an impact on the congregation; it must appear to the basic factor of interest in the congregation; it must be relevant to the subject matter; the title should be a promise on how the message should be; the title must not give away the whole context of the message; an ambiguous title but relevant to the needs of the congregation must ensure the interest of members","It must contain at least three scripture references","The title must be exactly the same as the main Bible text being preached"], answer: 1 },
      { q: "What does the word TEXT signify in Homiletics?", options: ["A written note given to the choir before the service","The word text is coined from the Latin word 'textus' or 'textum' which signifies something woven or spun — the text must not be chosen at the end of the sermon; the custom of ministers preaching from a text dates back to ages; for instance, Jesus Christ in Luke 4:18 took a text and preached His ministry of mercy to the world","A short announcement read at the beginning of the service","A written summary of the sermon distributed to the congregation"], answer: 1 },
      { q: "What are THREE advantages of having a text for a sermon?", options: ["The text makes the sermon shorter, easier to memorise and more entertaining","A good and well chosen text gives God's seal on the message; when a preacher reads a text, a good text awakens the interest of the congregation; a text arouses curiosity on what the preacher will say next; the preacher gains confidence by unfolding the thought of God contained in the text through an intelligent, prayerful, studious approach","A text only helps newer preachers who cannot speak without notes","A text ensures the congregation will not fall asleep during the sermon"], answer: 1 },
      { q: "According to the course, why should a preacher NOT only preach from a single circuit of texts?", options: ["Because using many texts will impress the congregation with the preacher's Bible knowledge","Faithful and honest development of each text will tend to vary in each preaching — preachers who form a habit of depending on a circuit lose freshness; moreover, preachers who frame themes will always run out of sermon themes; it is a very dangerous thing for a preacher to develop the habit of using text simply to keep them from desultory rambling","Because preaching from one circuit makes sermons too long","Because the congregation will memorise the preacher's texts and stop paying attention"], answer: 1 },
      { q: "What is the first guidance given for treating the selection of texts?", options: ["Always begin with texts from the book of Revelation for maximum impact","Have a good Bible with a good print; in addition to a good Bible, get an unabridged good print concordance (e.g. Cruden's Concordance) and a Scripture textbook","Ask the congregation to suggest texts for each sermon","Only select texts from the New Testament to keep sermons relevant"], answer: 1 },
      { q: "Why should a preacher avoid texts spoken only by wicked men, demons or false prophets?", options: ["Because such texts are too difficult to understand and explain","There are many speakers in the Bible whose statements ought not to be quoted as divine authority — these include Pharaoh, Herod, Absalom, Pilate, Judas Iscariot, demons, false prophets and wicked men that speak with no authority whatsoever; the words of these men, therefore, be wrong and misleading","Because such texts are not well known enough to interest the congregation","Because the congregation might be offended by hearing the words of evil characters"], answer: 1 },
      { q: "What does the course say about the preacher who FORCES texts to make them teach something foreign to divine intent?", options: ["This shows the preacher has great creativity and imagination","Do not force texts to make them teach something foreign to the divine intent — the text is not a mere motto for a free essay; neither is it a point of departure; do not treat a text out of context as that is a deliberate and intentional misuse and perversion of a text which is akin to a crime against the Holy Spirit","Forcing a text is acceptable when the congregation needs a particular message urgently","Forcing a text is only wrong when done by inexperienced preachers"], answer: 1 },
      { q: "What are the three principal types of biblical sermons as classified in the course?", options: ["Evangelistic, Pastoral and Missionary sermons","Topical, Textual and Expository sermons","Morning, Afternoon and Evening sermons","Short, Medium and Long sermons"], answer: 1 },
      { q: "How is a TOPICAL SERMON defined?", options: ["A sermon with no fixed Bible text, based entirely on the preacher's personal opinions","A topical sermon is one in which the main divisions are derived from the topic or theme — independently of a text; a topical sermon begins from the topic, independently of a text; a topical sermon is a Biblical sermon and the fact that a topical sermon does not require a text as its source of Biblical reference","A sermon that covers multiple topics in a single message without structure","A sermon preached exclusively during special church anniversaries"], answer: 1 },
      { q: "What is the key requirement for UNITY OF THOUGHT in a topical sermon?", options: ["Using at least ten scriptures to support each point","A topical sermon is one in which the main division is drawn from the topic and each division is also supported by a verse of scripture — all other important facts concerning the unanswered message must be omitted because the topic limits us to deal only with factors hindering answers to prayer","All points in the sermon must be exactly equal in length","The topic must be introduced with a story before any scriptures are used"], answer: 1 },
      { q: "What is the basic principle for preparing topical sermon outlines?", options: ["Always start the outline with a conclusion and work backwards","Main divisions of a topical sermon should be in logical or chronological order — any order followed must be determined by the nature of the topic to be discussed; we should aim to develop the outline in logical or chronological order","Topical outlines must always have exactly five main points","The outline must begin with the most controversial point to get immediate attention"], answer: 1 },
      { q: "In the example topical sermon on 'Satan, Our Arch Enemy', what are the four main division headings listed?", options: ["His wealth, his servants, his music and his food","His origin (Ezekiel 28:12-17), his activity (II Corinthians 6:11-12; Luke 11:14-18), his power (Ephesians 6:11-12; Luke 11:14-18; Luke 8:12) and his destiny (I Thessalonians 2:18; Matthew 25:41)","His name, his location, his helpers and his final defeat","His history, his church, his Bible and his followers"], answer: 1 },
      { q: "How is a TEXTUAL SERMON defined in Module XII?", options: ["A sermon in which the preacher speaks for hours without using any text","A textual sermon is one in which the main divisions are derived from a brief portion of Scripture — each of these divisions is a line of suggestion and the text provides the theme of the sermon; in a textual sermon, the main lines of development are drawn from the text itself","A sermon that uses only one Bible verse throughout the entire message","A sermon preached entirely from memory without notes or a Bible"], answer: 1 },
      { q: "How is an EXPOSITORY SERMON defined and what makes it most effective?", options: ["An expository sermon is one that is preached without any preparation","Of all the principal types of biblical sermons, the most effective form of pulpit address is the expository sermon — an expository sermon is one in which a more or less extended portion of scripture is interpreted in relation to a theme or a central idea; the bulk of the material for the sermon is drawn directly from the passage and the outline consists of progressive ideas built around that one main idea","An expository sermon is one that uses the most illustrations and stories","An expository sermon is one preached only at Bible college graduation ceremonies"], answer: 1 },
      { q: "What is the KEY DIFFERENCE between a textual and an expository sermon?", options: ["A textual sermon is longer than an expository sermon","A textual sermon is a type of sermon which main divisions are derived from a verse or two or sometimes a part of a verse — while in an expository sermon the preacher derives all sub-divisions from the same unit of scripture; the expository sermon is drawn directly from the text and the sermon becomes a definite exposition or interpretation of that text","An expository sermon uses more illustrations while textual sermons use more scriptures","A textual sermon is always topical while an expository sermon is never topical"], answer: 1 },
      { q: "What is the homiletical structure of a sermon as outlined in Module XIII?", options: ["Theme only, followed by an offering and closing prayer","Title, Text, Introduction, Body of Divisions (with main divisions and sub-divisions, each followed by discussion), and Conclusion","Welcome, worship, offering, sermon and dismissal","Prayer, scripture reading, personal testimony and benediction"], answer: 1 },
      { q: "What are the TWO FUNCTIONS of a good introduction?", options: ["It must raise money for the church and entertain the congregation","It arouses interest of the congregation and arrests the attention of members of the congregation while a bad introduction kills their interest","It must summarise the entire sermon and list all the scriptures to be used","It introduces the preacher to a new congregation and reads his biography"], answer: 1 },
      { q: "What are the VALUES OF DIVISIONS in the body of a sermon?", options: ["Divisions make the sermon longer and more impressive","Values of divisions to the preacher include: they promote clarity of thought; they assist the preacher in the proper treatment of a subject; they promote unity of thought; they enable the preacher to remember main points of the sermon — values to the congregation include: they make the sermon clear and much easier for listeners to follow the main message","Divisions only help younger preachers who are still learning","Divisions ensure that the congregation can easily predict what comes next"], answer: 1 },
      { q: "What is the purpose of the DEFINITION step in the Body of a sermon?", options: ["To read a long passage from a Bible commentary verbatim","The purpose of the first division of the Body of a sermon is to clearly and fully set forth the title of the sermon by definition, explanation, relation, contrast, illustration and comparison","To introduce the preacher's personal life story to the congregation","To explain why the preacher chose this particular text over others"], answer: 1 },
      { q: "What is an ILLUSTRATION in the context of sermon construction?", options: ["A drawing or picture shown to the congregation on a projector screen","Illustration is that part of the sermon which makes meaning of the sermon perfectly clear to the congregation — to illustrate means to explain by examples, pictures, etc.; an illustration can be defined simply as a means of throwing light upon a sermon by the use of an example","A humorous joke told at the beginning of a sermon to relax the congregation","A long quotation read from a famous Christian author's book"], answer: 1 },
      { q: "List FIVE values of illustration in sermon delivery.", options: ["They make the sermon longer, more expensive, easier to record, harder to criticise and more popular","Illustrations make the message clear; they ease tension of a congregation; they make the truth impressive; they make sermons to be remembered; they make preaching interesting; they help to persuade the congregation; they make repetition possible without weariness","They ensure the congregation gives a larger offering after service","They allow the preacher to avoid difficult theological questions"], answer: 1 },
      { q: "What is a SIMILE as a type of illustration, and an example given in the course?", options: ["A simile is a direct comparison of two things without using 'like' or 'as'","A simile is a comparison of two things to each other using 'like' or 'as' — example: 'He has a heart like stone' (simile)","A simile is an indirect reference to a famous historical event","A simile is a made-up story used to illustrate a moral lesson"], answer: 1 },
      { q: "What are the FOUR WAYS to conclude a sermon according to Module XIV?", options: ["Ask for offering, sing a hymn, pray and dismiss the congregation","There are four ways to conclude a sermon — a preacher is at liberty to use either of them: (i) Recapitulation: a brief summary of the whole sermon; (ii) Illustration: making the sermon clear with an example; (iii) Application: a process by which truth is brought to bear directly and personally upon individuals in order to persuade them; (iv) Motivation: moving the audience to action","Shout, clap, speak in tongues and give an altar call","Read a poem, sing a chorus, take attendance and dismiss"], answer: 1 }
    ]
  },
  ...
  // 
  {
    ...
    duration: 60,
    questions: [
      { q: "Who is identified as the \"maker and author of music\"?", options: ["David","Moses","God Himself","Solomon"], answer: 2 },
      { q: "God taught a song to which biblical figure to teach the Israelites?", options: ["Joshua","Moses","Samuel","Aaron"], answer: 1 },
      { q: "According to Martin Luther, a schoolmaster must know how to do what?", options: ["Play the drums","Sing","Dance","Paint"], answer: 1 },
      { q: "\"Music\" is defined as sound arranged to produce what in the listener's ear?", options: ["Confusion","Pleasantness","Noise","Fear"], answer: 1 },
      { q: "\"Chordophones\" are instruments that make sounds using:", options: ["Blowing air","Stretched strings or wire","Skins stretched over surface","Vibration of their bodies"], answer: 1 },
      { q: "\"Aerophones\" produce sound by:", options: ["Beating with hand","Blowing air into a tube","Plucking strings","Clapping hands"], answer: 1 },
      { q: "A \"Membranophone\" is typically:", options: ["A flute","A guitar","A drum (instrument made of skin)","A piano"], answer: 2 },
      { q: "\"Idiophones\" are self-sounding instruments like:", options: ["Trumpets","Organs","Shakers/Cymbals","Violins"], answer: 2 },
      { q: "The Oxford Advanced Learners' Dictionary defines a \"Song\" as a short:", options: ["Story","Poem or set of words set to music","Speech","Rulebook"], answer: 1 },
      { q: "A \"Hymn\" is designed to be sung and expresses the worshiper's attitude towards:", options: ["The government","God or God's purposes","Nature","Themselves"], answer: 1 },
      { q: "The Book of Psalms in the Old Testament consists of how many hymns?", options: ["100","120","150","200"], answer: 2 },
      { q: "What are the two characteristic ways of singing psalms?", options: ["Humming and shouting","Alternation between soloist/choir or two choirs","Whispering and crying","Fast and slow"], answer: 1 },
      { q: "In Roman Catholic liturgy, the \"Mass\" celebrates the:", options: ["New year","Last supper and sacrifice on the cross","First day of school","End of winter"], answer: 1 },
      { q: "The word \"Choir\" comes from the Greek word:", options: ["Logos","Theos","Chorus","Didasko"], answer: 2 },
      { q: "A \"Cantata\" is a composition for one or several:", options: ["Instruments","Voices","Dances","Books"], answer: 1 },
      { q: "\"Worship\" is defined as homage or reverence paid to a:", options: ["King","Deity","Teacher","Friend"], answer: 1 },
      { q: "\"Melody\" is a horizontal element consisting of a succession of:", options: ["Colors","Musical notes","Chords","Instruments"], answer: 1 },
      { q: "\"Harmony\" is a vertical element consisting of musical tones sounded:", options: ["One after the other","Simultaneously together","Silently","Only in the morning"], answer: 1 },
      { q: "The \"Beat\" is the pulse of music and the basic unit of:", options: ["Volume","Rhythm","Pitch","Dynamics"], answer: 1 },
      { q: "\"Meter\" is the arrangement of grouping equal beats into:", options: ["Lines","Sets or units","Songs","Sounds"], answer: 1 },
      { q: "\"Tempo\" refers to the:", options: ["Loudness","Rate or speed","Weight","Highness"], answer: 1 },
      { q: "A \"Chord\" is a group of how many or more tones sounded together?", options: ["One","Two","Three","Ten"], answer: 2 },
      { q: "\"Musical Texture\" refers to how many different layers of what are heard at once?", options: ["Colors","Sound","Instruments","Voices"], answer: 1 },
      { q: "In \"Monophonic\" texture, there is only a single:", options: ["Layer of cloth","Unaccompanied melodic line","Instrument playing","Person dancing"], answer: 1 },
      { q: "\"Polyphonic\" literally means:", options: ["One sound","Many sounding","Quiet sounding","Fast sounding"], answer: 1 },
      { q: "The \"Keynote\" (or tonic note) is the central tone towards which other tones:", options: ["Repel","Gravitate","Hide","Run"], answer: 1 },
      { q: "\"Sound\" begins with the what of an object?", options: ["Color","Vibration","Smell","Size"], answer: 1 },
      { q: "\"Pitch\" refers to the relative what of a sound?", options: ["Loudness or softness","Highness or lowness","Length or width","Beauty or ugliness"], answer: 1 },
      { q: "\"Dynamics\" refers to the:", options: ["Speed","Loudness or softness","Pitch","Tone color"], answer: 1 },
      { q: "\"Timbre\" is also known as:", options: ["Frequency","Tone color","Volume","Rhythm"], answer: 1 },
      { q: "\"Duration\" refers to the length of what a given sound is made?", options: ["Space","String","Time","Metal"], answer: 2 },
      { q: "Who was the first choir director mentioned in the Bible?", options: ["David","Asaph","Chenanaiah","Solomon"], answer: 2 },
      { q: "Who is identified as the \"father of all musicians\" in Genesis 4:21?", options: ["Adam","Cain","Jubal","Seth"], answer: 2 },
      { q: "Miriam and other women sang and danced to praise God in which book?", options: ["Genesis","Exodus","Judges","Psalms"], answer: 1 },
      { q: "Jericho fell to the sound of:", options: ["Harps","Trumpets","Drums","Cymbals"], answer: 1 },
      { q: "Which king experienced the \"soothing effect\" of music?", options: ["Solomon","David","Saul","Hezekiah"], answer: 2 },
      { q: "The \"Magnificat\" was the song of:", options: ["Elizabeth","Mary","Zechariah","Simeon"], answer: 1 },
      { q: "The \"Benedictus\" was the song of:", options: ["Joseph","Peter","Zechariah","John the Baptist"], answer: 2 },
      { q: "\"Praise and Worship\" are ways we appreciate God by declaring His:", options: ["Wealth","Excellence","Age","House"], answer: 1 },
      { q: "\"Tehillah\" means powerful praise of:", options: ["Sleep","Warfare and victory","Sadness","Hunger"], answer: 1 },
      { q: "\"Yahdah\" means worship with:", options: ["Closed eyes","Extended hand","Dancing feet","Loud drums"], answer: 1 },
      { q: "\"Halal\" means to:", options: ["Cry","Shine, boast, or celebrate","Bow down","Whisper"], answer: 1 },
      { q: "\"Barak\" means to:", options: ["Sing aloud","Bless or bow down in worship","Play instruments","Shout"], answer: 1 },
      { q: "\"Zamar\" refers to:", options: ["Vocal music","Instrumental worship (touching the strings)","Dance","Silent meditation"], answer: 1 },
      { q: "Which biblical text replaced sacrificial offerings in the Synagogue?", options: ["The Quran","The Torah (reading of the law)","The Iliad","The Republic"], answer: 1 },
      { q: "\"Latreuontes\" is a New Testament word for worship meaning:", options: ["Singing","Service","Love","Hope"], answer: 1 },
      { q: "A \"Semibreve\" is a symbol used to show the what of a note?", options: ["Pitch","Duration","Volume","Color"], answer: 1 },
      { q: "In the Tabernacle diagram, which part is for \"Singing in the spirit\"?", options: ["The Gate","The Outer Court","The Holy of Holies","The East side"], answer: 2 },
      { q: "\"Oil of Joy\" is a divine attribute associated with the:", options: ["Father","Son","Holy Spirit","Archangel Gabriel"], answer: 2 },
      { q: "The \"Pianissimo\" dynamic term means:", options: ["Loud","Soft","Very soft","Very loud"], answer: 2 }
    ]
  },
  ...
  // 
  {
    ...
    duration: 60,
    questions: [
      { q: "The term \"evangelism\" is derived from which Greek word?", options: ["Logos","Biblia","Evangellion","Musterion"], answer: 2 },
      { q: "What does the Greek word for evangelism literally mean?", options: ["To study","To sing","Good News","Church history"], answer: 2 },
      { q: "Which of the following is NOT considered a \"Gospel news\" according to the text?", options: ["Proclaiming Christ as Savior","Passing an examination","Carrying the Kingdom","Publishing the Word"], answer: 1 },
      { q: "In the Great Commission, who is the \"Commissioner\"?", options: ["The Pastor","The Disciples","Jesus Christ","The Church Elders"], answer: 2 },
      { q: "To which group was the Great Commission initially given?", options: ["120 people","70 disciples","11 disciples","The early Church in Rome"], answer: 2 },
      { q: "What is the primary aim of evangelism?", options: ["To increase church funds","To teach human philosophy","To bring individuals to a personal experiential knowledge of Christ","To maintain church traditions"], answer: 2 },
      { q: "Evangelism is an \"activity\" because it requires:", options: ["Thinking only","Action","Money only","Silence"], answer: 1 },
      { q: "Which scripture commands us to \"Preach the Word\"?", options: ["John 3:16","Romans 1:14","2 Timothy 4:2","Acts 1:8"], answer: 2 },
      { q: "Evangelism is NOT the same as \"Missions\" because on missions, Christ is taken to:", options: ["A sinner","A relative","A new place or environment","A local jail"], answer: 2 },
      { q: "The four requirements for the ministry of the church in evangelism include Presence, Proclamation, Participation, and:", options: ["Preparation","Penetration","Persuasion","Purification"], answer: 2 },
      { q: "The task of evangelism is described as a:", options: ["Charitable service","Professional job","Love debt we owe","Personal hobby"], answer: 2 },
      { q: "Which Bible verse says \"Go ye into all the world and preach the Gospel to every creature\"?", options: ["Matthew 28:18","Mark 16:15","Luke 24:45","John 20:21"], answer: 1 },
      { q: "Who is the ultimate Author of Evangelism?", options: ["The General Overseer","Apostle Paul","God Himself","The Council of Nicaea"], answer: 2 },
      { q: "What is a common misconception about the \"Training\" for evangelism?", options: ["It requires a Bible","It needs the Holy Spirit","Only the ordained should evangelize","It should be practical"], answer: 2 },
      { q: "The phrase \"The Bible and the plough regenerate Africa\" was a slogan for which mission concept?", options: ["Personal Evangelism","Literature Crusade","1841 Niger Expedition","Church Disease"], answer: 2 },
      { q: "Why do we evangelize according to Module III?", options: ["To gain fame","Because Hell is real and eternity is endless","To show off our knowledge","To travel the world"], answer: 1 },
      { q: "Which personality of the God-Head \"applies the Gospel to the heart of the sinner\"?", options: ["The Father","The Son","The Holy Spirit","The Archangel Gabriel"], answer: 2 },
      { q: "Personal Evangelism is also known as:", options: ["Net fishing","Mass preaching","One to one Evangelism","System doctrine"], answer: 2 },
      { q: "Which is a medium for Personal Evangelism?", options: ["Billboard","Television","Face to Face Discussion","Stadium Crusade"], answer: 2 },
      { q: "In the symbolism of Personal Evangelism, it is compared to:", options: ["Running a race","Catching a fish","Planting a garden","Building a tower"], answer: 1 },
      { q: "What is the \"Direct Approach\" in personal evangelism sometimes called?", options: ["Friendly chat","Digression method","Shock Tactics","Interrogative method"], answer: 2 },
      { q: "The \"Interrogative Approach\" involves using:", options: ["Loud arguments","Skillful questions that arouse interest","Legal documents","Silence"], answer: 1 },
      { q: "Which is an advantage of the \"Printed Page\" (Literature) in mass evangelism?", options: ["It needs a passport","It is not affected by prejudice","It reacts to insults","It changes its message often"], answer: 1 },
      { q: "In the \"Don'ts\" for the soul-winner, one should NOT:", options: ["Pray","Use the Bible","Monopolize the conversation","Follow up"], answer: 2 },
      { q: "Mass Evangelism is compared to using a:", options: ["Hook","Net","Spear","Trap"], answer: 1 },
      { q: "Which of the following is a terminal disease of the church occurring when people move away?", options: ["Ethnikitis","Ghost Town","Koinonitis","St. John's Syndrome"], answer: 1 },
      { q: "\"Ethnikitis\" occurs when the people around a church are:", options: ["Very wealthy","Culturally different from those in the church","All related to the pastor","Moving away"], answer: 1 },
      { q: "The \"cure\" for Sociological Strangulation is to:", options: ["Fire the elders","Stop fellowship","Expand the building or start shift services","Stop evangelism"], answer: 2 },
      { q: "Which disease describes a church that has lost its \"first love\" and passion?", options: ["Hyper Co-operativism","People Blindness","St. John's Syndrome","Koinonitis"], answer: 2 },
      { q: "\"Church Planting\" is described as the:", options: ["Least effective method of evangelism","Most effective method of evangelism","Duty of deacons only","System of doktrines"], answer: 1 },
      { q: "What is a vital sign of a healthy church?", options: ["Large bank account","Zeal for Evangelism and Missions","High quality sound system","Expensive cars for pastors"], answer: 1 },
      { q: "The \"Three phases\" of effective evangelism are Preparation, Penetration, and:", options: ["Promotion","Proclamation","Preservation","Persuasion"], answer: 2 },
      { q: "\"Follow up\" is the spiritual work of:", options: ["Finding new donors","Grounding a new believer in the faith","Counting the crowd","Organizing a picnic"], answer: 1 },
      { q: "Which factor is responsible for effective follow-up?", options: ["Wealth","Luck","Commitment","Fame"], answer: 2 },
      { q: "The \"Discipleship Area\" of follow-up aims to make the convert:", options: ["A member of the choir","Consistently growing into the image of Jesus","A political leader","A professional student"], answer: 1 },
      { q: "God is NOT interested in \"fishing without\":", options: ["A boat","A net","Catching","Bait"], answer: 2 },
      { q: "A growing church resembles the early church in being a:", options: ["Rich church","Saved, steadfast, and sharing church","Traditional church","Quiet church"], answer: 1 },
      { q: "Church Growth is the result of pastors developing the:", options: ["Mind of a businessman","Mind of Christ","Style of a celebrity","Skill of a politician"], answer: 1 },
      { q: "In planting a church in a \"Slum,\" the planter should:", options: ["Expect high tithes","Introduce a ministry of help","Build the most expensive cathedral","Avoid visiting the people"], answer: 1 },
      { q: "To start a church in a \"Government Reservation Area (GRA),\" one should:", options: ["Use shock tactics","Print invitation cards and invite important dignitaries","Preach only in the market","Shout with a megaphone"], answer: 1 },
      { q: "The \"Survey Stage\" of the soul-winner involves:", options: ["Asking for money","Diagnosing the seeker's opinion about salvation","Taking a map of the city","Building a church foundation"], answer: 1 },
      { q: "A soul-winner should NOT rely on their own:", options: ["Bible","Prayer","Ability","Faith"], answer: 2 },
      { q: "One advantage of Personal Evangelism is that it can be done:", options: ["Only on Sundays","Anytime and anywhere","Only by bishops","Only in a church building"], answer: 1 },
      { q: "Which is NOT a type of Mass Evangelism?", options: ["Literature Crusade","Electronic Media","Letter Writing","Outdoor Crusades"], answer: 2 },
      { q: "What was the world population when Jesus gave the Great Commission?", options: ["1 billion","250 million","4 billion","500 million"], answer: 1 },
      { q: "\"Koinonitis\" is a church disease that results from:", options: ["No fellowship","Too much self-centered fellowship","Lack of Bible study","Too many children"], answer: 1 },
      { q: "Effective evangelism aids growth, and according to Peter Wagner, it must begin and end with:", options: ["The seminary","The government","The local church","The mission board"], answer: 2 },
      { q: "In the Great Commission, \"Disciples\" are meant to be made, NOT just:", options: ["Believers","Moralists","Friends","Neighbors"], answer: 1 },
      { q: "\"Arrested Spiritual Development\" refers to a congregation of:", options: ["Elders","Baby Christians","Sinners","Foreigners"], answer: 1 },
      { q: "The \"Holy Club\" at the University of Oxford was founded by:", options: ["William Carey","John Wesley","Charles Spurgeon","Billy Graham"], answer: 1 }
    ]
  },
  ...
  // 
  {
    ...
    duration: 60,
    questions: [
      { q: "What is the literal meaning of \"Angelology\"?", options: ["The study of ancient human history","The word or study about the ambassador or messenger of God","The study of the Holy Spirit","The study of planetary movements"], answer: 1 },
      { q: "How many times are angels mentioned in the total Scriptures?", options: ["108 times","165 times","273 times","34 times"], answer: 2 },
      { q: "In the Hebrew language, the word for angel is \"Malak,\" which means:", options: ["A winged human","To dispatch as a deputy, messenger, or ambassador","A fairy creature","The breath of God"], answer: 1 },
      { q: "Which of these books of the Bible does NOT mention angels?", options: ["Genesis","Job","Ruth","Revelation"], answer: 2 },
      { q: "Angels are described in Hebrews 1:7 as:", options: ["Material beings with weight","Winds and a flame of fire","Reincarnated humans","Impersonal sources of power"], answer: 1 },
      { q: "According to Colossians 1:16, who created the angels?", options: ["They have always existed","God the Father through Jesus Christ","The Archangel Michael","They evolved from lower spirits"], answer: 1 },
      { q: "Angels are classified as \"personal beings\" because they possess:", options: ["Physical bodies like humans","Intellect, emotions, and wills","The ability to reproduce","Divine status equal to God"], answer: 1 },
      { q: "Which of the following is a major difference between angels and the Holy Spirit?", options: ["Angels are one, the Holy Spirit is many","Angels are messengers; the Holy Spirit is God Himself","Angels dwell within bodies; the Holy Spirit has a bodily shape","There is no difference"], answer: 1 },
      { q: "How were angels originally created?", options: ["In a state of sin","Holy","As physical humans","As impersonal forces"], answer: 1 },
      { q: "The two major divisions of angels created after the probationary period are:", options: ["Gabriel and Michael","Good angels and bad angels","Cherubims and Seraphims","Archangels and Watchers"], answer: 1 },
      { q: "Who is the archangel portrayed as the commander who expelled bad angels from heaven?", options: ["Gabriel","Michael","Lucifer","Uriel"], answer: 1 },
      { q: "Which angel is known as the \"Chief messenger\" who announced the birth of Jesus?", options: ["Michael","Gabriel","Raphael","Nego"], answer: 1 },
      { q: "Bad angels consist of:", options: ["Disobedient humans","The devil and his angels","Only Lucifer","Deceased sinners"], answer: 1 },
      { q: "What is the source of the time of angels' origin?", options: ["After the creation of man","Prior to the foundations of the earth","During the New Testament era","After the fall of Adam"], answer: 1 },
      { q: "Angels are considered a \"Company\" and not a \"Race\" because:", options: ["They are few in number","They do not reproduce themselves","They all live in one house","They have the same name"], answer: 1 },
      { q: "The name \"Michael\" means:", options: ["Man of God","Who is like God?","Shining one","Messenger of peace"], answer: 1 },
      { q: "Gabriel is often described by Bible scholars as the:", options: ["Minister of warfare","Minister for information","Minister of music","Minister of finance"], answer: 1 },
      { q: "The name \"Lucifer\" means:", options: ["Dark one","Shining one or star of the morning","Accuser","Father of lies"], answer: 1 },
      { q: "Which type of angels are proclaimers and protectors of God's glorious presence?", options: ["Seraphims","Cherubims","Archangels","Guardian angels"], answer: 1 },
      { q: "The \"Seraphims\" are described as having how many wings?", options: ["Two","Four","Six","Eight"], answer: 2 },
      { q: "What does the name \"Sons of the Mighty\" describe?", options: ["Angels as a class of strong ones carrying out God's will","Human kings","The children of Israel","The twelve apostles"], answer: 0 },
      { q: "Angels referred to as \"Watchers\" serve as:", options: ["Military soldiers","Supervisors of God's work and agents of the Almighty","Singers in the choir","Gatekeepers of hell"], answer: 1 },
      { q: "Regarding their nature, angels are:", options: ["Material beings with weight","Spirit beings without material bodies","Subject to physical growth and aging","Higher than God"], answer: 1 },
      { q: "Can angels reproduce?", options: ["Yes, they have families","No, they are incapable of reproducing","Only the Archangels can","Only if God gives them a human body"], answer: 1 },
      { q: "According to Hebrews 2:7, mankind was created:", options: ["Higher than angels","Lower than angels","Equal to angels","Before angels"], answer: 1 },
      { q: "Angels are immortal because:", options: ["They eat special fruit","They cannot die","They are gods","They stay in heaven only"], answer: 1 },
      { q: "In II Kings 19:35, how many Assyrians did one angel kill in a single night?", options: ["1,000","144,000","185,000","10,000"], answer: 2 },
      { q: "How many angels did John see in Revelation 5:11?", options: ["Twelve","One hundred","Ten thousand times ten thousand and thousands of thousands","Seven"], answer: 2 },
      { q: "Which of the following is a characteristic of angels?", options: ["They are omniscient","They can appear as human","They are omnipresent","They are all-powerful like God"], answer: 1 },
      { q: "Angels minister to God by:", options: ["Correcting His mistakes","Worshipping His Person and performing His will","Teaching Him the Gospel","Providing Him with strength"], answer: 1 },
      { q: "Which angel warned Joseph to flee to Egypt to protect the infant Jesus?", options: ["An unnamed angel","Gabriel","Michael","Lucifer"], answer: 0 },
      { q: "Angels ministered to Jesus after His exhaustion from:", options: ["Walking to Jerusalem","Forty days of temptation","Building the temple","Preaching to the 5,000"], answer: 1 },
      { q: "Who rolled away the stone from Jesus' tomb?", options: ["The disciples","An angel","The Roman soldiers","Jesus Himself"], answer: 1 },
      { q: "Hebrews 1:14 describes angels' ministry to believers as:", options: ["Commanding spirits","Ministering spirits sent to aid believers","Punishing spirits","Governing spirits"], answer: 1 },
      { q: "Which angel was sent to shut the lions' mouths to protect Daniel?", options: ["An angel of God","Gabriel","Michael","A watcher"], answer: 0 },
      { q: "An angel appeared to Zacharias to announce the birth of:", options: ["Jesus","John the Baptist","Samson","Isaac"], answer: 1 },
      { q: "When a believer like Lazarus dies, angels:", options: ["Judge his soul","Carry him to Abraham's bosom","Leave him in the grave","Reincarnate him"], answer: 1 },
      { q: "Angels will be involved in meting out judgment on:", options: ["Only the righteous","Unbelievers","No one","Only animals"], answer: 1 },
      { q: "Which of the following is something angels CANNOT do?", options: ["Appear as men","Call God 'Father' as a son","Travel between heaven and earth","Sing praises"], answer: 1 },
      { q: "Angels of God are forbidden from:", options: ["Serving humans","Receiving worship","Obeying God","Fighting demons"], answer: 1 },
      { q: "According to Hebrews 1, Christ is superior to angels because:", options: ["He is older","He is God's only begotten Son","He has more wings","He lives in a different heaven"], answer: 1 },
      { q: "In the future, redeemed man will be:", options: ["Lower than angels forever","Exalted above angels","Turned into angels","Ignored by angels"], answer: 1 },
      { q: "The eternal future for evil angels is to be:", options: ["Redeemed at last","Cast into the lake of fire (hell) forever","Released back to heaven","Turned into humans"], answer: 1 },
      { q: "What is the biblical stance on worshipping angels?", options: ["It is encouraged for Archangels","It is strictly forbidden","It is allowed in the New Testament","It is necessary for miracles"], answer: 1 },
      { q: "How should a believer \"try the spirits\" or test an angel?", options: ["By seeing if he is handsome","By seeing if his words and purpose line up with the Bible","By asking for spectacular lights","By seeing if he socializes and hangs around"], answer: 1 },
      { q: "A real angel of God will never:", options: ["Give a message from God","Testify of himself or draw attention away from Jesus","Help a believer out of danger","Worship God"], answer: 1 },
      { q: "Angelology helps us recognize the warfare that exists between:", options: ["Different human nations","God's angels and Satan and his demons","The flesh and the bone","Science and religion"], answer: 1 },
      { q: "Which angel appeared to Mary to tell her she would bear the Son of God?", options: ["Michael","Gabriel","Lucifer","A seraphim"], answer: 1 },
      { q: "Angels were created to glorify:", options: ["Themselves","Jesus Christ","The earth","Human achievements"], answer: 1 },
      { q: "In the first 3.5 years of the tribulation, angels will:", options: ["Seal 144,000 Israelites","End the world immediately","Stop preaching","Become human beings"], answer: 0 }
    ]
  },
  ...
  // 
  {
    ...
    duration: 60,
    questions: [
      { q: "What is Hermeneutics defined as in the lecture notes?", options: ["The study of ancient fossils","The translational art of converting Hebrew to Latin","The art and science of interpretation of literary works","The biological study of human speech"], answer: 2 },
      { q: "Why is Hermeneutics called an \"art\"?", options: ["It uses paint and brushes to explain the Bible","It paints a picture of the scene and has flexible rules","It is only practiced by professional artists","It requires no formal rules or guidelines"], answer: 1 },
      { q: "Hermeneutics is considered a \"science\" because it:", options: ["Relies on chemical reactions","Involves specialized knowledge and an orderly system of rules","Only deals with biology and physics","Disproves the existence of God"], answer: 1 },
      { q: "What is the etymological origin of the word \"Hermeneutics\"?", options: ["The Latin word Vulgate","The Hebrew word Torah","The Greek word hermeneuo","The English word Harmony"], answer: 2 },
      { q: "Who is the messenger-god to whom the origin of the name Hermeneutics is often traced?", options: ["Zeus","Hermes","Apollo","Hades"], answer: 1 },
      { q: "What is \"General Hermeneutics\"?", options: ["The study of military ranks in the Bible","The art and science of interpretation of all kinds of literature as a whole","The interpretation of only the four Gospels","A method used only for interpreting laws"], answer: 1 },
      { q: "\"Special Hermeneutics\" is the interpretation of:", options: ["A specific segment or portion of a whole literature","Only the New Testament","All books written by humans","Scientific journals only"], answer: 0 },
      { q: "What is the primary objective of Biblical Hermeneutics?", options: ["To prove the interpreter is always right","To read one's own viewpoint into the text (eisegesis)","To help read within the text (exegesis)","To replace the Bible with commentaries"], answer: 2 },
      { q: "Biblical interpretation began in which period?", options: ["During the creation of the world","The period between the Testaments","The 19th Century","Only after the Reformation"], answer: 1 },
      { q: "Which Old Testament book is mentioned as a \"first example\" of biblical interpretation?", options: ["Genesis","Leviticus","Deuteronomy","Malachi"], answer: 2 },
      { q: "What is a \"Bigot\" in the context of a Bible interpreter?", options: ["A person with a very high IQ","Someone who refuses to budge from their viewpoint even when proven wrong","A professional Greek scholar","A member of the clergy"], answer: 1 },
      { q: "The goal of the hermeneutic process is to:", options: ["Win arguments in the church","Be matured in Christ and conformed to His image","Memorize every word in the Bible","Become a wealthy philosopher"], answer: 1 },
      { q: "Which of the following is a reason for difficulty in understanding the biblical text?", options: ["The Bible is too short","We are separated from events by thousands of years and different cultures","God intended for no one to understand it","There are no rules for grammar in the Bible"], answer: 1 },
      { q: "What does the term \"Exegesis\" mean?", options: ["Reading meaning into the Bible","Drawing meaning out of the Scriptures","Ignoring the original author's intent","Translating the Bible into a modern language"], answer: 1 },
      { q: "\"The secret things belong to the LORD, but the things revealed belong to us\" is found in:", options: ["John 3:16","Deuteronomy 29:29","Psalm 23","Revelation 1:1"], answer: 1 },
      { q: "What is the number one qualification for a Bible interpreter?", options: ["A PhD in Theology","Being Born Again (regenerated)","Being older than 50 years","Living in Jerusalem"], answer: 1 },
      { q: "Why must a Bible interpreter be \"Spirit Filled\"?", options: ["To impress the congregation","Because the Word came through men moved by the Holy Spirit","To bypass the need for study","To change the text of the Bible"], answer: 1 },
      { q: "The Holy Spirit's role as \"Paracletos\" means He is our:", options: ["Judge","Enemy","Comforter or Counselor","Accountant"], answer: 2 },
      { q: "What does \"Syntax\" refer to in Hermeneutics?", options: ["The history of church taxes","The way words are grouped in phrases and sentences","The speed at which one reads the Bible","The number of pages in a book"], answer: 1 },
      { q: "Which figure of speech uses \"like\" or \"as\" for comparison?", options: ["Metaphor","Simile","Hyperbole","Irony"], answer: 1 },
      { q: "What is a \"Metaphor\"?", options: ["An explicit comparison using \"like\"","An implicit comparison without using \"like\" or \"as\"","A statement that contradicts itself","A literal historical fact"], answer: 1 },
      { q: "The phrase \"The trees of the field shall clap their hands\" is an example of:", options: ["Simile","Personification","Metonymy","Euphemism"], answer: 1 },
      { q: "\"Hyperbole\" is a figure of speech that uses:", options: ["Understatement","Sarcasm","Exaggeration to make a point","Animal names for people"], answer: 2 },
      { q: "Using \"He has passed on to glory\" instead of \"He died\" is called:", options: ["Irony","Synecdoche","Euphemism","Ellipsis"], answer: 2 },
      { q: "The literal meaning of the Greek word Oikodome is:", options: ["Preaching a sermon","Building a house","Fishing for men","Planting a garden"], answer: 1 },
      { q: "What is the \"Literalist\" method of interpretation?", options: ["Taking the Bible at face value and reading it as literature","Finding a hidden secret code in every letter","Ignoring the words to find a \"vibe\"","Changing the meaning to fit modern science"], answer: 0 },
      { q: "Which method seeks to find a \"hidden\" or \"symbolic\" meaning under the literal text?", options: ["Literal","Allegorical","Natural","Historical"], answer: 1 },
      { q: "In \"Typological\" interpretation, a \"Type\" is a:", options: ["A mistake in the printing of the Bible","A shadow or event in the OT that is realized in the NT","A specific kind of font used by the author","A human opinion about God"], answer: 1 },
      { q: "Which school of thought states that Jesus was a myth created by early Christians?", options: ["Moral","Mystical","Mythical","Literal"], answer: 2 },
      { q: "The \"Natural Method\" or \"Rationalist\" school of thought believes:", options: ["Every miracle is literal","Miracles should be tested by human reasoning and science","The Bible was written by nature","God does not have a personality"], answer: 1 },
      { q: "What is the \"Rule of first mention\" also known as?", options: ["Rule of Context","Principle of Precedence","Rule of Logic","Principle of Usage"], answer: 1 },
      { q: "The \"Rule of Context\" states you should never:", options: ["Read more than one verse at a time","Read the New Testament","Interpret a passage in isolation","Ask for the Holy Spirit's help"], answer: 2 },
      { q: "What does the \"Rule of Logic\" help an interpreter identify?", options: ["Hidden treasures of gold","Errors in interpretation that sound ridiculous or illogical","The exact date of the rapture","The weight of the Ark of the Covenant"], answer: 1 },
      { q: "The \"Principle of Historical Judgment\" requires the interpreter to be familiar with:", options: ["Modern computer technology","The history, life, and society of the original listeners","The future history of the world","The biography of the interpreter"], answer: 1 },
      { q: "The \"Principle of Unity\" states there must be no contradictions between:", options: ["The Bible and a daily newspaper","The Old Testament and the New Testament","Different versions of the English Bible","The pastor and the choir"], answer: 1 },
      { q: "How many consonants are in the Hebrew Alphabet?", options: ["24","22","26","39"], answer: 1 },
      { q: "How many letters are in the Greek Alphabet?", options: ["22","24","27","66"], answer: 1 },
      { q: "The first letter of the Greek Alphabet is:", options: ["Omega","Alpha","Beta","Zeta"], answer: 1 },
      { q: "The last letter of the Greek Alphabet is:", options: ["Alpha","Omega","Gamma","Psi"], answer: 1 },
      { q: "The \"Law of Revelation\" states that hermeneutics must:", options: ["Be done without prayer","Reveal something from God with the Spirit's help","Be kept a secret from the congregation","Only be done by scientists"], answer: 1 },
      { q: "The \"Law of Authority\" shows the Word of God as a \"hammer\" based on:", options: ["Genesis 1:1","Psalm 23","Jeremiah 23:29","John 14:6"], answer: 2 },
      { q: "The \"Law of Progress\" implies that God:", options: ["Never tells the truth","Releases truth to us in stages","Wants the world to end immediately","Is changing His mind about sin"], answer: 1 },
      { q: "What is the ultimate \"Goal of Hermeneutics\"?", options: ["To become famous","Edification (Oikodome)","To collect antique Bibles","To win a debate against skeptics"], answer: 1 },
      { q: "\"Etymology\" is the study of:", options: ["Insects","The origin and history of words","The stars and planets","Ancient ruins"], answer: 1 },
      { q: "Which ancient manuscript is the Greek translation of the Old Testament?", options: ["The Vulgate","The Septuagint (LXX)","The Dead Sea Scrolls","The King James Version"], answer: 1 },
      { q: "What is \"Eisegesis\"?", options: ["Drawing meaning out of the text","Reading one's own viewpoint into the text","A Hebrew word for \"Holy\"","The study of the Holy Spirit"], answer: 1 },
      { q: "The \"Mystical Method\" borders on:", options: ["Scientific logic","Historical facts","Magical practices and non-scriptural processes","Greek grammar"], answer: 2 },
      { q: "In the \"Moral Method,\" what attribute of God is often overemphasized while ignoring His holiness?", options: ["Power","Love","Eternity","Truth"], answer: 1 },
      { q: "\"Bible interpretation\" is a core subject in the:", options: ["Medical field","Theological training of a minister","Legal profession","Engineering curriculum"], answer: 1 },
      { q: "Who is the General Overseer of RCCG mentioned in the preface of the lecture notes?", options: ["Moses","Pastor E. A. Adeboye","Apostle Paul","Miles Coverdale"], answer: 1 }
    ]
  },
...
const SOD_EXAMS = [
  ...
  // 5. YEAR 5
  {
    ...
    questions: [
      ...
      // ---- PAPER 1 (Q1–50) ----
      { q: "When Jesus Christ defeated the devil he, brought ______, ______ and ______ to people.", options: ["salvation, victory, heaven", "faith, hope, love", "joy, relief, abundance"], answer: 2 },
      { q: "When Jesus defeated the devil, he changed emptiness to ______ and defeat to ______.", options: ["fulfilment, glory, victory", "fullness, joy, success", "full, boldness, recovery"], answer: 0 },
      { q: "When Elijah defeat the devil he brought in ______.", options: ["shout for joy", "shower of blessing", "song of victory"], answer: 1 },
      { q: "What was the problem in the city Elisha went to?", options: ["people are groaning for their situation", "things are not going on fine", "water is naught and ground is barren"], answer: 2 },
      { q: "When Elisha wanted to solve the problem of the city he spoke with ______.", options: ["authority", "permission", "determination"], answer: 0 },
      { q: "Jesus Christ expects his disciples to do ______ works.", options: ["Excellent", "Wonderful", "Greater"], answer: 2 },
      { q: "Elijah defeated death once while Jesus defeat death ______.", options: ["finally", "permanent", "totally"], answer: 1 },
      { q: "Elijah conquered death once but Christ took the ______ of death.", options: ["key", "fear", "force"], answer: 0 },
      { q: "Since Jesus has overcome death disciples also have ______ over death.", options: ["say", "control", "power"], answer: 2 },
      { q: "There is limitation to what disciples can do when there are no resources.", options: ["True", "False", "Not sure"], answer: 1 },
      { q: "It is possible to serve Jesus without knowing him.", options: ["True", "False", "Not sure"], answer: 1 },
      { q: "The father-son relationship between God and the disciples can only be deepened in quality with constant ______ with God.", options: ["fellowship", "standing", "speaking"], answer: 0 },
      { q: "God is as close to disciples as their breath even if they are far from him.", options: ["True", "False", "Not sure"], answer: 1 },
      { q: "As disciples we must begin our relationship with ______ then move on to ______ our shepherd.", options: ["signs, wonders", "hearing, knowing", "dream, vision"], answer: 1 },
      { q: "Aside from shepherd recognizing the voice of God they must also ______.", options: ["accept God", "believe God", "know God"], answer: 2 },
      { q: "Getting the full knowledge of God is a ______ process.", options: ["gradual", "sudden", "tremendous"], answer: 0 },
      { q: "No disciple need assistance of anyone at any time before getting full knowledge of God.", options: ["True", "False", "Not sure"], answer: 1 },
      { q: "To develop any ability in Christ as a disciple requires ______ and ______ intimacy with God.", options: ["consistent, progressive", "timely, continuous", "immediate, closer"], answer: 0 },
      { q: "Disciples needs to get to the point of ______ fellowship with Christ.", options: ["crucial", "important", "unlimited"], answer: 2 },
      { q: "For disciples to be able to say he is one with the father he/she must move from the stage of ______ reading the scriptures to ______ on it all the time.", options: ["mere, meditating", "studying, understanding", "simply, application"], answer: 0 },
      { q: "Disciples must drink from Christ to quench their thirst for them to have ______.", options: ["peace of mind", "well of life", "happiness of salvation"], answer: 1 },
      { q: "A person may have potential to do greater works but must first ______.", options: ["fast for forty days", "have connection with Christ", "do lots of miracles"], answer: 1 },
      { q: "The water Christ have for those who come to him is ______.", options: ["Message of truth", "Miracles, signs and wonder", "Holy spirit"], answer: 2 },
      { q: "The river of water in you will flow through your ______.", options: ["mouth", "heart", "head"], answer: 0 },
      { q: "The stream of life can use ______, ______ and ______ to flow.", options: ["Bible, minister, church", "Doctrine, ministry, denomination", "Psalm, hymn, spiritual songs"], answer: 2 },
      { q: "The ______ of a disciple will be determined by how freely you allow the river flow out of ______.", options: ["strength", "power", "effectiveness"], answer: 0 },
      { q: "Praying with human understanding won't allow the river flow forever except by praying in ______.", options: ["scriptures", "tongues", "fasting"], answer: 1 },
      { q: "The day of Pentecost is the special day set aside for the move of Holy Spirit.", options: ["True", "False", "Not sure"], answer: 1 },
      { q: "God has anointed his disciples so they can be his ______.", options: ["workmanship", "servant", "son"], answer: 0 },
      { q: "The days are evil therefore disciples are admonished to be ______ the time.", options: ["watchful of", "careful of", "redeeming"], answer: 2 },
      { q: "Since disciples are anointed as king they are expected to ______.", options: ["reign", "wage war", "overcome"], answer: 0 },
      { q: "One man offence brought ______, another man's righteousness brings ______.", options: ["doubt, faith", "death, life", "failure, success"], answer: 1 },
      { q: "Kings are expected to ______ not ______.", options: ["command, beg", "win, control", "rule, reign"], answer: 0 },
      { q: "As disciples you are expected to be king over the following except ______.", options: ["demons", "evil forces", "disciples"], answer: 2 },
      { q: "As a priest of the most high God you are expected to ______ your people.", options: ["lead", "lord", "load"], answer: 0 },
      { q: "The mission of Paul to Damascus is to ______ the believers of Jesus.", options: ["arrest", "persecute", "kill"], answer: 1 },
      { q: "The nature of the disciples is like that of the Holy one.", options: ["True", "False", "Not sure"], answer: 0 },
      { q: "In him was ______; and the life was the ______ of men.", options: ["victory, glory", "life, light"], answer: 1 },
      { q: "I am the ______ of the world: he that follows me shall not walk in ______, but shall have the light of ______.", options: ["light, darkness, life", "saviour, fear, God", "hope, failure, victory"], answer: 0 },
      { q: "Ye are the ______ of the world.", options: ["sons", "disciple", "light"], answer: 2 },
      { q: "The Holy one which is the divine nature is ______.", options: ["brightness", "light", "greatness"], answer: 1 },
      { q: "As soon as disciples have divine nature, ______ follows.", options: ["creativity", "miracles", "power"], answer: 0 },
      { q: "God can exceedingly above that which we ask or think according to the ______ that works in us.", options: ["might", "power", "grace"], answer: 1 },
      { q: "Disciples can now create because at the point of salvation their ______ changed.", options: ["language", "life", "destiny"], answer: 0 },
      { q: "To create the right thing as God's disciple we need ______ and ______.", options: ["power, understanding", "Jesus, God", "power, wisdom"], answer: 2 },
      { q: "God gives disciples the ability to also be a creator because he loves to ______.", options: ["delegate duties", "train them", "test them"], answer: 0 },
      { q: "Disciples are the branches, Jesus is the vine while God is the ______.", options: ["planter", "husbandman", "keeper"], answer: 1 },
      { q: "In addition to wisdom, knowledge and understanding expected of disciples to be a creator they must also include ______.", options: ["good works", "faith", "power"], answer: 0 },
      { q: "You will be strengthened with all might, according to his glorious power unto all ______ and ______ with ______.", options: ["faith, persecution, victory", "waiting, set back, happiness", "patience, long suffering, joyfulness"], answer: 2 },
      { q: "According to Psalm 100, ______ is what you need to serve the Lord as a disciple.", options: ["gladness", "sincerity", "whole heart"], answer: 0 },

      // ---- PAPER 2 (Q51–100) ----
      { q: "For miracle to be done disciples must have ______ God will make it happen through Holy Spirit.", options: ["hope", "faith", "believe"], answer: 1 },
      { q: "Who are those that something eyes have not seen, ears have not heard are prepared for? They that ______ him.", options: ["love", "follow", "want"], answer: 0 },
      { q: "What is the requirement for disciples to do greater works than Jesus?", options: ["Been his disciple", "Be his follower", "believing in him"], answer: 2 },
      { q: "What must happen before comforter can come?", options: ["Jesus Christ must ascend", "Jesus Christ must descend", "Jesus Christ must be killed"], answer: 0 },
      { q: "Disciples can begin to know their role in the plans of God through prompting of ______.", options: ["prayer", "Holy spirit", "ministration"], answer: 1 },
      { q: "When a disciple can do some things others find difficult to do easily, it could be pointing to the direction God is planning to use him/her.", options: ["True", "False", "Not sure"], answer: 0 },
      { q: "There are some work which the master can do but the disciples must not go near.", options: ["True", "False", "Not sure"], answer: 1 },
      { q: "Once a believer accepts Christ they should begin to work wonders.", options: ["True", "False", "Not sure"], answer: 0 },
      { q: "The current situation of a person is enough for God to conclude on usefulness of the person.", options: ["True", "False"], answer: 1 },
      { q: "Miracles can be done with availability of man and presence of ______.", options: ["fasting", "prayer", "Holy spirit"], answer: 2 },
      { q: "God does nothing without a purpose, but everyone must discover it through power of Holy Spirit by ______.", options: ["evangelism", "worshiping", "obedience"], answer: 0 },
      { q: "We are likened to clay while God to potter because ______.", options: ["He will mold us", "He decides what he want us to be", "He chooses for us"], answer: 1 },
      { q: "Some vessels might be abandoned because they are not ______.", options: ["hard", "responsible", "Malleable"], answer: 2 },
      { q: "Disciples must surrender themselves to God to do the following except ______.", options: ["Fight for their right", "Winning soul for God", "Defending their faith"], answer: 0 },
      { q: "Disciples must be ______, ______ and ______ for God to use them effectively.", options: ["soft, flexible, malleable", "hard, rigorous, self-contented", "free, soft, manipulable"], answer: 0 },
      { q: "Mortality - Holy Spirit = ______", options: ["something", "nothing", "vessel"], answer: 1 },
      { q: "Clay + Holy Spirit = ______", options: ["design", "vessel", "pot"], answer: 1 },
      { q: "The purpose of God almighty for my life is realizable by making myself ______.", options: ["Strong and determined", "Weak and simple", "Available and useable"], answer: 2 },
      { q: "God needs someone with the following principal things except, someone who ______.", options: ["believe in God", "is totally obedient", "is available"], answer: 0 },
      { q: "The following people in the bible obeyed God except ______.", options: ["Abraham", "Saul", "Noah"], answer: 1 },
      { q: "Miracles that are not activated are in the category of ______.", options: ["energy at work", "kinetic energy", "potential energy"], answer: 2 },
      { q: "Miracles that are activated are in the category of ______.", options: ["kinetic energy", "potential energy", "energy at rest"], answer: 0 },
      { q: "Signs will follow disciples who ______.", options: ["preaches", "believe", "is a pastor"], answer: 1 },
      { q: "God needs someone to examine his children, hence ______.", options: ["Promote Satan", "He empower Satan", "He keeps Satan alive"], answer: 2 },
      { q: "Pleading the blood of Jesus and then taking authority over the oppressor are the two steps ______.", options: ["to preach the gospel", "Humiliate the devil", "Execute deliverance"], answer: 2 },
      { q: "When Christ was yet to form in Peter ______.", options: ["He started to walk on water", "He started to defend Jesus with sword", "He started to sink while walking on water"], answer: 2 },
      { q: "Jesus loves everybody he gives ______.", options: ["All things to anyone", "Freedom to anyone", "Prosperity to anyone"], answer: 1 },
      { q: "Because disciples are complete in Jesus, so ______.", options: ["Demons fear us", "We can cast out demons", "We can underestimate demons"], answer: 1 },
      { q: "Satan is still free ______.", options: ["Partially", "Seldomly", "Totally"], answer: 2 },
      { q: "Satan has no access to the disciples, who ______.", options: ["His old in Christ", "Can pray in tongue", "Walks as Christ walk"], answer: 2 },
      { q: "Because love is costly, disciples is ______.", options: ["Reluctant to give free flow to eternal love", "Gives it to his lover", "Never give it to anyone"], answer: 0 },
      { q: "Spiritual gift the disciple require to make everything possible for him are the following except ______.", options: ["Faith", "Boldness", "Holiness"], answer: 1 },
      { q: "The disciples have divine nature, hence, he is a partaker of ______.", options: ["Life and light", "Death and resurrection", "Character and Dignity"], answer: 0 },
      { q: "Since disciples have divine nature, he is equally his ______.", options: ["Boldness", "Fear of God", "Creative ability"], answer: 2 },
      { q: "Disciples require simply common sense, though, he has the power of God in him.", options: ["True", "False", "None of the above"], answer: 1 },
      { q: "The cup that Jesus Christ fear so much was ______.", options: ["The vinegar", "Crucifixion", "None of the above"], answer: 2 },
      { q: "Demons should be bounded and devil should be ______.", options: ["resisted", "feared", "ignored"], answer: 0 },
      { q: "The zones disciples can operate has the presence of God through ______ and in ______.", options: ["salvation, glory", "Christ, Love", "Holy spirit, miracle"], answer: 1 },
      { q: "Disciple must display their love of God to other through ______.", options: ["Crusade", "Evangelism", "Baptism of the Holy Spirit"], answer: 1 },
      { q: "Walking in love as a disciple means being a ______.", options: ["giver", "pastor", "missionary"], answer: 2 },
      { q: "It is only if you go out ______, ______, and ______ follow your missionary assignment.", options: ["signs, miracle, wonders", "faith, deliverance, glory", "soul winning, conversion, salvation"], answer: 0 },
      { q: "The actors in the stage of history are ______.", options: ["winner and loser", "Jesus and devil", "creator and destroyer"], answer: 1 },
      { q: "In every contest there are rules governing them, which of the following is not for the contest on the stage of life.", options: ["law of life", "law of death", "law of gravity"], answer: 2 },
      { q: "When the love within linked with the love outside then we are partakers of ______.", options: ["Divine love", "His glory", "eternity"], answer: 0 },
      { q: "Love produce ______, drives away ______, produce ______ and overcome ______.", options: ["light, darkness, holiness, sin", "long suffering, doubt, faith, sin", "generosity, fear, joy, death"], answer: 0 },
      { q: "When Jesus love us, he carried our ______.", options: ["fears", "burden", "mistakes"], answer: 1 },
      { q: "Out of love disciples must ______ backslidden fellows.", options: ["rally round", "give to", "counsel"], answer: 0 },
      { q: "What must disciple do to bring everybody to Christ?", options: ["sacrifice", "pray", "show kindness"], answer: 0 },
      { q: "What does a disciple ______ needs to be a conqueror of death?", options: ["God kind of love", "patience", "long suffering"], answer: 0 },
      { q: "Believing in Jesus gives people ______.", options: ["assurance", "eternal life", "faith"], answer: 1 }
...
const SIT_EXAMS = [
  ...
  // ---- STEWARDS REFRESHER COURSE ----
  {
    ...
    questions: [
      ...
      // ---- STEWARDSHIP, SONSHIP & SERVICE (Q1–30) ----
      { q: "A believer says, \"I am already accepted in Christ, so I do not need to prove anything through service.\" Which response best reflects the balance of the teaching?", options: ["The believer is wrong because acceptance before God is sustained by visible service", "The believer is partly right, but acceptance in Christ should produce responsible stewardship", "The believer is correct because sonship removes the need for spiritual responsibility", "The believer is wrong because service is the only evidence of salvation"], answer: 1 },
      { q: "Which statement best distinguishes approval as a believer from approval as a steward?", options: ["A believer is approved by faith, while a steward is approved by public usefulness", "A believer is approved by faith, while a steward is proven through faithful handling of truth", "A believer is approved by obedience, while a steward is approved by spiritual gifting", "A believer and a steward are approved in exactly the same way without further responsibility"], answer: 1 },
      { q: "A steward frequently quotes Scripture but repeatedly applies it outside its intended meaning. What is the most accurate diagnosis?", options: ["The steward has zeal for Scripture but lacks sufficient public teaching confidence", "The steward has exposure to Scripture but has not rightly divided the Word of truth", "The steward has passion for doctrine but may need more church leadership visibility", "The steward understands Scripture but may need more emotional balance in delivery"], answer: 1 },
      { q: "Which statement sounds spiritual but subtly reflects volunteering rather than stewardship?", options: ["\"I am willing to support whenever I am available and led.\"", "\"I have been entrusted with this assignment, so I must give account.\"", "\"I may not be seen, but I must remain faithful.\"", "\"This is God's work, so I must handle it with diligence.\""], answer: 0 },
      { q: "A steward becomes discouraged because no one publicly acknowledged their sacrifice. What issue is most likely being exposed?", options: ["The steward needs a better encouragement structure from leadership", "The steward may be confusing human appreciation with divine approval", "The steward is probably not called to that area of service", "The steward has served beyond the limit expected of a volunteer"], answer: 1 },
      { q: "Which option best explains why \"sonship before service\" is not an excuse for passivity?", options: ["Sonship removes striving, but stewardship still requires faithful responsibility", "Sonship gives identity, so service becomes unnecessary for mature believers", "Sonship proves acceptance, while service proves superiority among believers", "Sonship makes private devotion more important than any form of church work"], answer: 0 },
      { q: "A steward accepts correction privately but becomes offended when corrected publicly. What does this most likely reveal?", options: ["The steward values order and prefers correction to follow the right process", "The steward may still attach identity to image, perception and recognition", "The steward is teachable but has a strong sensitivity to poor communication", "The steward is spiritually mature but prefers honour in the correction process"], answer: 1 },
      { q: "Which person is most likely operating from wrong identity in service?", options: ["One who serves faithfully but occasionally feels stretched by assignment", "One who receives correction but takes time to process it before adjusting", "One who feels reduced whenever another person is recognized", "One who asks for clarity before accepting a responsibility"], answer: 2 },
      { q: "\"Public fire is sustained by private oil\" would most directly challenge which steward?", options: ["One who serves visibly but does not maintain consistent private fellowship", "One who prays privately but is still growing in public confidence", "One who studies Scripture but has not yet mastered public expression", "One who serves quietly and is not frequently noticed by people"], answer: 0 },
      { q: "A steward who is always available for church work but rarely studies, prays or reflects is most likely confusing:", options: ["Availability with spiritual preparedness", "Service with spiritual maturity", "Activity with kingdom relevance", "Responsibility with personal sacrifice"], answer: 0 },

      // ---- SPARK FRAMEWORK & SCRIPTURE (Q11–20) ----
      { q: "In the SPARK framework, which combination best captures the inner structure that sustains stewardship?", options: ["Study, Prayer, Accountability, Reflection and Knowledge", "Scripture, Prayer, Alignment, Reflection and Koinonia", "Service, Preparation, Availability, Responsibility and Kingdom focus", "Scripture, Praise, Assignment, Renewal and Knowledge"], answer: 1 },
      { q: "A worker teaches confidently but cannot correct error accurately. What is the most precise weakness?", options: ["The worker has zeal but needs stronger spiritual boldness", "The worker has expression but lacks right handling of Scripture", "The worker has knowledge but needs more public teaching exposure", "The worker has gifting but lacks sufficient church commitment"], answer: 1 },
      { q: "Which statement best reflects the implication of 2 Timothy 3:16 for a steward?", options: ["Scripture equips the steward mainly for public teaching and doctrinal debates", "Scripture first corrects, trains and shapes the steward before public use", "Scripture is profitable when the steward needs to correct other people", "Scripture gives the steward authority once they can quote it properly"], answer: 1 },
      { q: "A person studies the Word only to teach others but never allows it to correct personal conduct. What has been missed?", options: ["The instructional value of Scripture for public ministry", "The corrective and formative role of Scripture in the steward's own life", "The apologetic value of Scripture for defending faith", "The motivational role of Scripture in strengthening confidence"], answer: 1 },
      { q: "Which option best describes \"rightly dividing the Word of truth\"?", options: ["Knowing many scriptures and applying them boldly to real situations", "Explaining Scripture accurately, contextually and responsibly", "Teaching Scripture with confidence and practical illustrations", "Using Scripture to correct error and defend sound doctrine"], answer: 1 },
      { q: "A steward refuses correction because \"God speaks to me directly.\" Which truth is being ignored?", options: ["Direct revelation must still produce humility, teachability and accountability", "Direct revelation is unreliable unless confirmed by church leadership", "Correction is mostly useful for stewards who are still spiritually immature", "A steward who hears God personally does not need human input"], answer: 0 },
      { q: "Which is the most dangerous use of Scripture by a steward?", options: ["Using Scripture to correct personal conduct before correcting others", "Using Scripture to defend truth while ignoring personal transformation", "Using Scripture to strengthen conviction and instruct in righteousness", "Using Scripture to test motives, doctrine and service posture"], answer: 1 },
      { q: "A gifted steward is careless with doctrine. Why is this especially dangerous?", options: ["Giftedness attracts attention, so mishandled truth can mislead many people", "Giftedness is less important than doctrine in every area of church life", "Gifted stewards are usually less accountable because people trust them", "Giftedness can only be useful after a person becomes doctrinally perfect"], answer: 0 },
      { q: "The phrase \"not ashamed\" in relation to labouring in the Word suggests that shame may come when a steward:", options: ["Is corrected while still learning to explain Scripture", "Mishandles the truth they are expected to represent", "Serves faithfully but does not have a public title", "Studies privately but struggles with public boldness"], answer: 1 },
      { q: "Which option best captures the relationship between study and service?", options: ["Study gives depth to service so that activity is not separated from truth", "Study is mainly necessary for stewards who teach publicly", "Service validates study because practice is more important than doctrine", "Study and service are separate responsibilities with different purposes"], answer: 0 },

      // ---- STEWARD vs VOLUNTEER (Q21–30) ----
      { q: "A steward differs from a volunteer primarily because a steward:", options: ["Serves more frequently than a volunteer", "Carries accountability for what has been entrusted", "Is more gifted than a volunteer", "Receives more responsibility from leadership"], answer: 1 },
      { q: "Which statement sounds responsible but may still reveal a volunteer mindset?", options: ["\"I will support when my schedule permits.\"", "\"I will serve faithfully even when unseen.\"", "\"I understand that this assignment was entrusted to me.\"", "\"I must give account for the way I handle this responsibility.\""], answer: 0 },
      { q: "A person accepts service only when the role is visible. What is the most accurate concern?", options: ["The person may be naturally suited for public-facing assignments", "The person may be more driven by recognition than stewardship", "The person may need better clarity on their spiritual gifts", "The person may be avoiding areas where they are not effective"], answer: 1 },
      { q: "Which statement best reflects stewardship?", options: ["\"I will serve where I am strongest so I can give God my best.\"", "\"I will treat God's work as an entrusted responsibility, not a casual activity.\"", "\"I will support the work as long as the expectations are reasonable.\"", "\"I will serve when I sense that my contribution is genuinely needed.\""], answer: 1 },
      { q: "A steward says, \"Nobody paid me, so I can do it anyhow.\" What has the steward misunderstood?", options: ["Payment is not the only basis for excellence and accountability in God's work", "Unpaid service should still be appreciated by leaders and members", "Church work may be voluntary but should still be reasonably structured", "Excellence is expected mostly when the assignment affects many people"], answer: 0 },
      { q: "Which statement most clearly reflects a steward's mindset?", options: ["\"I can step back once the assignment becomes too demanding.\"", "\"This assignment is entrusted to me, so I cannot treat it casually.\"", "\"I will serve better when I am placed where people can see my contribution.\"", "\"I will continue as long as I feel spiritually motivated.\""], answer: 1 },
      { q: "A volunteer mindset becomes dangerous in ministry because it can make a person:", options: ["Serve without first developing spiritual capacity", "Treat divine assignment as optional and convenience-based", "Focus too much on excellence instead of grace", "Depend too heavily on leadership for direction"], answer: 1 },
      { q: "A steward remains faithful in an unseen assignment. What does this most strongly demonstrate?", options: ["The steward does not desire leadership responsibility", "The steward serves from God's approval, not public applause", "The steward is naturally humble and avoids visible roles", "The steward is still being prepared for more important work"], answer: 1 },
      { q: "Which situation best tests stewardship under pressure?", options: ["Serving faithfully when the assignment is inconvenient and unseen", "Serving effectively when the assignment matches one's strengths", "Serving joyfully when leaders appreciate the effort", "Serving consistently when the task is public and impactful"], answer: 0 },
      { q: "Which option best captures the full idea of stewardship from the notes?", options: ["Supporting church work with availability, sincerity and willingness", "Managing God's assignment with faithfulness, accountability, private devotion and diligence", "Serving in the house of God with passion, loyalty and visible commitment", "Helping leadership fulfil church objectives through consistent participation"], answer: 1 },

      // ---- IDENTITY & CORRECTION (Q31–40) ----
      { q: "\"Sonship before service\" matters because service without identity can produce:", options: ["Activity that looks committed but is driven by insecurity", "Service that is humble but lacks public confidence", "Responsibility that is sincere but lacks technical skill", "Commitment that is strong but not properly structured"], answer: 0 },
      { q: "A worker becomes offended whenever corrected. What is the deepest concern?", options: ["The worker may need correction to be communicated more gently", "The worker may be confusing correction with rejection", "The worker may not yet understand departmental expectations", "The worker may be struggling with leadership style"], answer: 1 },
      { q: "A steward says, \"If I am not leading it, I am not interested.\" What is most likely being exposed?", options: ["A need to clarify the steward's area of calling", "A struggle with identity, visibility and kingdom collaboration", "A desire to serve only where the steward can be most effective", "A concern that leadership is not using the steward properly"], answer: 1 },
      { q: "Which statement best reflects a secure son serving as a steward?", options: ["\"Correction may be uncomfortable, but it does not reduce my identity.\"", "\"Correction should be accepted only when it is communicated honourably.\"", "\"Correction is useful when it comes from someone spiritually higher.\"", "\"Correction proves that I still have much to do before I am accepted.\""], answer: 0 },
      { q: "Wrong identity in service often causes a person to interpret correction as:", options: ["A process of refinement", "A form of rejection", "A leadership responsibility", "A call to deeper maturity"], answer: 1 },
      { q: "Which person shows the clearest evidence of sonship before service?", options: ["One who serves joyfully when appreciated and corrects quickly when noticed", "One who receives correction, adjusts, and remains faithful without offence", "One who serves passionately in areas that match their strength", "One who avoids conflict by staying away from visible assignments"], answer: 1 },
      { q: "A steward is always comparing their assignment with another person's assignment. What is most likely the issue?", options: ["Lack of clarity about departmental roles", "A struggle with contentment, identity and assignment", "A desire to ensure fairness in service distribution", "Weakness in understanding church structure"], answer: 1 },
      { q: "Which option best explains approval addiction in service?", options: ["Desire to serve God excellently and be encouraged by people", "Dependence on human recognition to feel valuable in service", "Need for feedback so one can measure service effectiveness", "Commitment to visible assignments where impact can be seen"], answer: 1 },
      { q: "A person burns out because they are trying to please everyone. What shift has likely happened?", options: ["From stewardship to leadership responsibility", "From God's approval to human approval", "From private devotion to public service", "From obedience to departmental excellence"], answer: 1 },
      { q: "\"A man in obedience will not miss God's blessing\" means the safest posture in service is:", options: ["Faithful obedience even when it is not convenient", "Spiritual sensitivity to serve only when led", "Visible commitment to the work of God", "Consistent involvement in church activities"], answer: 0 },

      // ---- PRIVATE DEVOTION & SPARK (Q41–50) ----
      { q: "Which of the following is the most subtle sign of burnout from pleasing people?", options: ["Refusing to serve when emotionally tired", "Becoming resentful when effort is unseen", "Asking for support when stretched", "Reducing activity to rebuild private devotion"], answer: 1 },
      { q: "A steward serves consistently in public but has no consistent private devotion. Why is this dangerous?", options: ["The steward may become dependent on activity without inner spiritual supply", "The steward may not be considered serious by leadership over time", "The steward may be less effective in public communication", "The steward may eventually prefer service to doctrine"], answer: 0 },
      { q: "Which option best represents the private life expected of a steward?", options: ["Spiritual gift, regular attendance and willingness to serve", "Private altar, daily meeting with God and devotional discipline", "Strong prayer life, public zeal and visible commitment", "Scripture knowledge, church loyalty and leadership submission"], answer: 1 },
      { q: "In the SPARK framework, \"Alignment\" would most likely require a steward to ask:", options: ["\"Is my assignment producing measurable results?\"", "\"Are my heart, motives and actions consistent with God's will?\"", "\"Am I serving in the area where my gifts are most visible?\"", "\"Are people recognizing the value of my contribution?\""], answer: 1 },
      { q: "\"Reflection\" in the SPARK framework is important because it helps the steward:", options: ["Review motives, obedience, growth and spiritual posture", "Measure public impact and departmental relevance", "Replace emotional reaction with strategic thinking", "Identify the weaknesses of others in the work"], answer: 0 },
      { q: "\"Koinonia\" in the SPARK framework points most directly to:", options: ["Fellowship with God and the brethren", "Strong relationship with church leadership", "Active participation in church programmes", "Public connection with the body of Christ"], answer: 0 },
      { q: "A steward prays only when prayer is officially scheduled. What may be missing?", options: ["Understanding that prayer is both personal devotion and stewardship responsibility", "Understanding that corporate prayer is more important than private prayer", "Understanding that stewards should pray mainly when assigned to do so", "Understanding that prayer should be balanced with visible service"], answer: 0 },
      { q: "Praying for the pastor and the church is part of stewardship because:", options: ["It shows loyalty to leadership and commitment to the assembly", "It reflects responsibility for the strength, health and advance of the work", "It helps the steward remain visible as a serious member of the church", "It is the primary way stewards prove their commitment to service"], answer: 1 },
      { q: "Praying for \"open doors for the gospel\" is most directly connected to:", options: ["Church publicity and broader community awareness", "Evangelistic opportunity and access for the Word", "Numerical church growth and better attendance", "Increased visibility for the steward's assignment"], answer: 1 },
      { q: "Praying for more labourers means the steward understands that:", options: ["Growth requires responsible people who can carry the work", "The church needs more people to reduce pressure on current workers", "The pastor should not be the only one preaching and teaching", "Every member must eventually belong to a service department"], answer: 0 },

      // ---- LOVE, FORGIVENESS & EVANGELISM (Q51–60) ----
      { q: "A steward forgives verbally but keeps emotional records and withdraws support. Which teaching is most directly contradicted?", options: ["Giving must continue as long as the steward is alive", "Love must be sincere and forgiveness must be real", "Evangelism must include follow-up and integration", "Prayer must be consistent and not occasional"], answer: 1 },
      { q: "\"Unforgiveness can put a limit to your prayers\" means spiritual activity may be hindered by:", options: ["A heart posture that contradicts the mercy received from God", "A lack of visible reconciliation before other believers", "Failure to serve consistently despite personal offence", "Insufficient prayer against bitterness and resentment"], answer: 0 },
      { q: "A person advertises the church, brings people in, but does not follow them up. What has the person missed?", options: ["The difference between church publicity and evangelism", "The responsibility of retention and abiding fruit", "The importance of inviting people consistently", "The need to make church attractive to outsiders"], answer: 1 },
      { q: "Which statement best captures \"Don't catch a fish and leave them to wander\"?", options: ["Evangelism must move beyond invitation to intentional follow-up and integration", "Evangelism is incomplete when visitors do not immediately join a department", "Evangelism requires publicity, invitation and consistent church attendance", "Evangelism should be handled by those gifted in follow-up and care"], answer: 0 },
      { q: "A steward gives consistently but refuses correction. What is the most balanced conclusion?", options: ["Giving is valuable, but stewardship also requires teachability and accountability", "Giving is evidence of commitment, so correction should be handled gently", "Giving proves the steward's heart, even if correction remains difficult", "Giving and correction are separate areas and should not be compared"], answer: 0 },
      { q: "\"Love God on weekdays as much as on Sundays\" challenges which attitude?", options: ["Serving publicly while maintaining private devotion", "Being spiritually expressive in church but inconsistent outside church", "Attending church faithfully while still growing in personal discipline", "Showing love for God through worship, giving and service"], answer: 1 },
      { q: "\"Don't be pretentious; love God and love one another\" most directly warns against:", options: ["Outward spirituality that is not matched by sincere love", "Public service that is not supported by strong doctrine", "Visible affection that lacks proper spiritual boundaries", "Emotional worship that does not translate into giving"], answer: 0 },
      { q: "\"Do not be lazy; do the work of God enthusiastically\" means service should be:", options: ["Energetic, visible and consistent before people", "Diligent, committed and wholehearted before God", "Passionate, structured and recognized by leadership", "Frequent, cheerful and emotionally expressive"], answer: 1 },
      { q: "\"Don't do anything for doing sake\" means a steward must avoid:", options: ["Serving without public excellence and proper visibility", "Serving without intentionality, care and spiritual weight", "Serving without leadership supervision and structure", "Serving without personal passion and emotional energy"], answer: 1 },
      { q: "\"Whatever you give God does not die\" means giving to God has:", options: ["Spiritual and eternal value beyond immediate visibility", "Greater value when it is sacrificial and publicly known", "Eternal value only when it is done cheerfully", "Spiritual value because it proves the steward's maturity"], answer: 0 },

      // ---- ALTAR CONSCIOUSNESS (Q61–70) ----
      { q: "\"The altar is not a stage\" most accurately means that sacred service must not be treated as:", options: ["A platform for performance and personal display", "A place where people can minister with confidence", "A public responsibility that requires preparation", "A visible assignment that demands excellence"], answer: 0 },
      { q: "A steward who is more concerned about how people perceive their service than how God receives it has most likely confused:", options: ["Excellence with preparation", "The altar with a stage", "Reverence with fear", "Service with responsibility"], answer: 1 },
      { q: "\"Learn to steward moments\" means a steward should:", options: ["Recognize sacred moments and handle them with spiritual sensitivity", "Make every moment memorable through strong public expression", "Ensure that every service moment reflects personal gifting", "Use service moments to build confidence and visibility"], answer: 0 },
      { q: "Habakkuk 2:20, in the context of altar consciousness, most directly points to:", options: ["Confidence before God's people", "Silence, reverence and awareness of God's presence", "Public boldness in spiritual assignments", "The importance of speaking during sacred moments"], answer: 1 },
      { q: "A steward who jokes carelessly around the altar because \"God understands my personality\" has most likely missed:", options: ["The difference between fear of punishment and fear of God", "The need to become more naturally expressive in service", "The importance of being relaxed in God's house", "The difference between personality and spiritual gifting"], answer: 0 },
      { q: "Which statement best reflects altar consciousness?", options: ["\"Since I am serving God, my heart matters more than how I behave.\"", "\"Because the altar is sacred, my conduct around it must reflect reverence.\"", "\"Since the altar is not a stage, excellence is not necessary.\"", "\"Because God sees my heart, outward order is secondary.\""], answer: 1 },
      { q: "A steward who handles the microphone, pulpit or altar space casually is not merely failing in protocol but in:", options: ["Public confidence", "Spiritual reverence", "Administrative coordination", "Personal expression"], answer: 1 },
      { q: "The most subtle danger in treating the altar as a stage is that a steward may:", options: ["Prepare too much and become too excellent", "Turn sacred service into self-projection", "Lose the ability to communicate publicly", "Avoid visible responsibilities completely"], answer: 1 },
      { q: "Hebrews 5:13-15, in the context of the notes, points most closely to the need for:", options: ["Spiritual maturity and trained discernment", "Public teaching and stage confidence", "More visible service opportunities", "Emotional excitement in worship"], answer: 0 },
      { q: "A steward who cannot discern when a moment is sacred and should be handled differently may be lacking:", options: ["Natural boldness", "Trained spiritual senses", "Leadership title", "Vocal expression"], answer: 1 },

      // ---- FEAR OF GOD IN SERVICE (Q71–80) ----
      { q: "Fear of God in service is best understood as:", options: ["Anxiety that God may punish every service error", "Reverence, honour and awe in handling God's work", "Avoiding service because one may make mistakes", "Strict obedience only when leaders are watching"], answer: 1 },
      { q: "Which statement best distinguishes fear of God from fear of punishment?", options: ["Fear of punishment avoids consequences; fear of God honours God's presence", "Fear of God is emotional fear; fear of punishment is spiritual maturity", "Fear of punishment produces excellence; fear of God produces hesitation", "Fear of God is only necessary when serving on the altar"], answer: 0 },
      { q: "A steward who arrives late repeatedly but says, \"At least I eventually came,\" may have failed to display fear of God in:", options: ["Spiritual gifting", "Punctuality", "Public confidence", "Personal calling"], answer: 1 },
      { q: "Punctuality in service is not merely about time management; in the notes, it is also a reflection of:", options: ["Personal ambition", "Fear of God and honour for sacred responsibility", "Desire to impress leadership", "Natural discipline without spirituality"], answer: 1 },
      { q: "A steward who dresses carelessly for service because \"God looks at the heart\" has misunderstood that appearance in service can also reflect:", options: ["Reverence and honour", "Fashion consciousness", "Leadership ranking", "Personal creativity"], answer: 0 },
      { q: "The note on \"appearance and dressing\" most strongly teaches that:", options: ["Dressing should draw attention to the steward's personality", "Dressing should reflect reverence, order and understanding of sacred service", "Dressing is irrelevant as long as the steward is sincere", "Dressing matters only for people serving on the altar"], answer: 1 },
      { q: "Which of the following best reflects fear of God in speech and attitude?", options: ["Speaking freely because familiarity shows confidence", "Speaking and behaving with honour because sacred service is involved", "Avoiding all speech so one does not make mistakes", "Speaking boldly even when the moment requires restraint"], answer: 1 },
      { q: "A steward receives an instruction but treats it casually because it came from a person and not directly from God. What has the steward missed?", options: ["Instructions connected to sacred service must be handled with reverence", "Human instructions are always equal to Scripture", "Every instruction must be obeyed without understanding", "Leaders must repeat instructions before they become important"], answer: 0 },
      { q: "Handling instructions with fear of God means:", options: ["Obeying only when the instruction is convenient and clear", "Receiving, processing and executing instructions with seriousness and honour", "Waiting until the instruction is announced publicly", "Asking others to confirm before taking responsibility"], answer: 1 },
      { q: "Ecclesiastes 5:1, in relation to service, most directly warns a steward to:", options: ["Be careful and reverent in approaching God's presence", "Speak more boldly when standing before people", "Focus mainly on giving offerings correctly", "Avoid serving until completely mature"], answer: 0 },

      // ---- JOSHUA & SERVANT LEADERSHIP (Q81–100) ----
      { q: "The first introduction of Joshua as a servant teaches that God often begins leadership stories with:", options: ["Public recognition and visible authority", "Hidden faithfulness and willingness to serve another's vision", "Personal ambition and strong leadership desire", "Immediate prominence before preparation"], answer: 1 },
      { q: "\"Before God makes you prominent, He makes you useful\" means that:", options: ["Usefulness in hidden assignments often precedes visible leadership", "Prominence is more important than usefulness", "God promotes people mainly because of potential", "Usefulness matters only when people notice it"], answer: 0 },
      { q: "A steward who wants influence but avoids service has misunderstood that servanthood is:", options: ["A step down from leadership", "Training for dominion", "Useful only for junior believers", "A temporary embarrassment before promotion"], answer: 1 },
      { q: "\"Servanthood is not a demotion; it is the path up\" most directly challenges the belief that:", options: ["Serving another person's vision is inferior", "Leadership requires training", "Faithfulness should be tested", "Service should be done excellently"], answer: 0 },
      { q: "A true servant does not merely tolerate the leader's vision but:", options: ["Waits for their own vision to become visible", "Embraces, protects and invests energy into it", "Supports it only when it matches personal goals", "Respects it publicly but privately stays detached"], answer: 1 },
      { q: "Which statement best reflects serving without entitlement?", options: ["\"I have served long enough, so I deserve recognition.\"", "\"I will remain faithful without demanding reward as a right.\"", "\"I should be promoted because I have potential.\"", "\"I will serve better once my effort is announced.\""], answer: 1 },
      { q: "\"Grows without announcement\" means a steward should:", options: ["Wait for public recognition before developing capacity", "Allow hidden consistency to produce growth before visibility", "Avoid being noticed in every form of service", "Reject affirmation when it eventually comes"], answer: 1 },
      { q: "A steward who is faithful only when placed in the spotlight has not yet understood:", options: ["Public communication", "Hidden faithfulness", "Spiritual boldness", "Leadership visibility"], answer: 1 },
      { q: "Joshua served as warrior, minister, presence dweller, spy and strategist. This shows that servant-leaders should be:", options: ["Boxed into one assignment only", "Available beyond personal preference", "Interested only in assignments that fit their title", "Promoted quickly because of variety"], answer: 1 },
      { q: "\"Availability is the currency of the servant leader\" means:", options: ["A servant leader must be everywhere at every time without rest", "Willingness and readiness to serve create leadership capacity", "Availability matters more than spiritual formation", "A servant leader should accept every task without discernment"], answer: 1 },
      { q: "\"Moses left; Joshua stayed\" reveals that Joshua's strength was not only in service but in:", options: ["Lingering hunger for God's presence", "Desire to replace Moses quickly", "Public loyalty before the people", "Interest in leadership position"], answer: 0 },
      { q: "The \"Secret Place Advantage\" teaches that what Joshua absorbed privately became:", options: ["A substitute for leadership training", "Spiritual capital for future leadership", "A reason to avoid public assignment", "Evidence that he no longer needed Moses"], answer: 1 },
      { q: "\"What you do after your leader leaves reveals your true hunger\" means that true hunger is tested when:", options: ["Supervision is absent", "Public attention increases", "Instructions are repeated", "The assignment becomes popular"], answer: 0 },
      { q: "A steward who imitates a leader's methods but does not pursue the God behind the leader's life may inherit:", options: ["The form without the fire", "The fire without the method", "The title without any responsibility", "The assignment without any testing"], answer: 0 },
      { q: "\"You cannot inherit what you compete with\" most directly teaches that succession requires:", options: ["Loyalty without rivalry", "Ambition without hesitation", "Visibility without correction", "Admiration without connection"], answer: 0 },
      { q: "Joshua's response when others bowed in the spies' report shows that faithfulness is tested by:", options: ["Whether one can stand when others compromise", "Whether one can speak louder than others", "Whether one is older than others", "Whether one has the strongest title"], answer: 0 },
      { q: "\"God does not promote potential; He promotes proven faithfulness\" means:", options: ["Potential has no value in God's work", "Faithfulness under testing carries more weight than unproven ability", "Gifted people are less likely to be promoted", "Promotion depends only on time served"], answer: 1 },
      { q: "The Spirit transfer in Joshua's story involved God identifying the vessel, Moses imparting into him, and the people receiving him. This shows that leadership transition requires:", options: ["Divine selection, spiritual impartation and communal recognition", "Personal ambition, public announcement and immediate authority", "Private desire, natural gifting and family endorsement", "Visible charisma, popularity and seniority"], answer: 0 },
      { q: "\"You don't become what you admire occasionally; you become what you stay connected to consistently\" teaches that formation is shaped by:", options: ["Occasional admiration", "Consistent connection", "Public excitement", "Short-term exposure"], answer: 1 },
      { q: "The six stages of how leaders are raised from Joshua's life are:", options: ["Calling, gifting, visibility, promotion, title and recognition", "Attachment, engagement, exposure, testing, impartation and affirmation", "Service, teaching, correction, applause, reward and leadership", "Availability, loyalty, maturity, recognition, authority and succession"], answer: 1 },
